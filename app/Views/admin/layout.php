...
<body>
    ...
    <div class="sidebar">
        ...
        <nav>
            <a href="/admin" class="nav-link <?= $isActive(['/admin']) && !$isActive(['/admin/stats', '/admin/products', '/admin/product', '/admin/settings', '/admin/articles', '/admin/ai-vocabulary', '/admin/ai-article', '/admin/ai-review']) ? 'active' : '' ?>"><i class="bi bi-speedometer2"></i> 仪表盘</a>
            <a href="/admin/stats" class="nav-link <?= $isActive(['/admin/stats']) ? 'active' : '' ?>"><i class="bi bi-bar-chart-line"></i> 统计</a>
