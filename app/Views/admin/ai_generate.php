...
<div class="card mb-4">
    ...
    <div class="collapse" id="configPanel">
        <div class="card-body border-bottom bg-light">
            <form method="POST" action="/admin/ai-config/save" class="row g-3 align-items-end">
                <div class="col-md-3">
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="/admin/ai-task/create" class="btn btn-sm btn-primary"><i class="bi bi-plus"></i> 新建任务</a>
    </div>
    <div class="card-body">
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr class="<?= $t['is_active'] ? '' : 'table-secondary' ?>">
                        ...
                        <td>
                            <a href="/admin/ai-task/edit/<?= $t['id'] ?>" class="btn btn-sm btn-outline-primary">编辑</a>
                            <a href="/admin/ai-task/toggle/<?= $t['id'] ?>" class="btn btn-sm btn-outline-<?= $t['is_active'] ? 'warning' : 'success' ?>">
                                <?= $t['is_active'] ? '停用' : '启用' ?>
                            </a>
                            ...
                            <a href="/admin/ai-task/delete/<?= $t['id'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('确定删除此任务？')">
