...
`,Re=(e="value")=>(t,i)=>{const o=t.constructor,s=o.prototype.attributeChangedCallback;o.prototype.attributeChangedCallback=function(r,n,l){var d;const p=o.getPropertyOptions(e),g=typeof p.attribute=="string"?p.attribute:e;if(r===g){const u=p.converter||Le,m=(typeof u=="function"?u:(d=u==null?void 0:u.fromAttribute)!=null?d:Le.fromAttribute)(l,p.type);this[e]!==m&&(this[i]=m)}s.call(this,r,n,l)}},we=k`
...
`,xt=class{constructor(e,...t){this.slotNames=[],this.handleSlotChange=i=>{const o=i.target;(this.slotNames.includes("[default]")&&!o.name||o.name&&this.slotNames.includes(o.name))&&this.host.requestUpdate()},(this.host=e).addController(this),this.slotNames=t}hasDefaultSlot(){return[...this.host.childNodes].some(e=>{if(e.nodeType===e.TEXT_NODE&&e.textContent.trim()!=="")return!0;if(e.nodeType===e.ELEMENT_NODE){const t=e;if(t.tagName.toLowerCase()==="sl-visually-hidden")return!1;if(!t.hasAttribute("slot"))return!0}return!1})}hasNamedSlot(e){return this.host.querySelector(`:scope > [slot="${e}"]`)!==null}test(e){return e==="[default]"?this.hasDefaultSlot():this.hasNamedSlot(e)}hostConnected(){this.host.shadowRoot.addEventListener("slotchange",this.handleSlotChange)}hostDisconnected(){this.host.shadowRoot.removeEventListener("slotchange",this.handleSlotChange)}};function ga(e){if(!e)return"";const t=e.assignedNodes({flatten:!0});let i="";return[...t].forEach(o=>{o.nodeType===Node.TEXT_NODE&&(i+=o.textContent)}),i}var lo="";function ms(e){lo=e}function ma(e=""){if(!lo){const t=[...document.getElementsByTagName("script")],i=t.find(o=>o.hasAttribute("data-shoelace"));if(i)ms(i.getAttribute("data-shoelace"));else{const o=t.find(r=>/shoelace(\.min)?\.js($|\?)/.test(r.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(r.src));let s="";o&&(s=o.getAttribute("src")),ms(s.split("/").slice(0,-1).join("/"))}}return lo.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var ba={name:"default",resolver:e=>ma(`assets/icons/${e}.svg`)},va=ba,bs={caret:`
  ...
  `},ya={name:"system",resolver:e=>e in bs?`data:image/svg+xml,${encodeURIComponent(bs[e])}`:""},xa=ya,wa=[va,xa],co=[];function _a(e){co.push(e)}function ka(e){co=co.filter(t=>t!==e)}function vs(e){return wa.find(t=>t.name===e)}var $a=k`
  :host {
    display: inline-block;
    width: 1em;
    height: 1em;
...
`;function _(e,t){const i=ee({waitUntilFirstUpdate:!1},t);return(o,s)=>{const{update:r}=o,n=Array.isArray(e)?e:[e];o.update=function(l){n.forEach(d=>{const p=d;if(l.has(p)){const g=l.get(p),u=this[p];g!==u&&(!i.waitUntilFirstUpdate||this.hasUpdated)&&this[s](g,u)}}),r.call(this,l)}}}var P=k`
  :host {
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ye=ui(class extends fi{constructor(e){if(super(e),e.type!==qt.PROPERTY&&e.type!==qt.ATTRIBUTE&&e.type!==qt.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!er(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===Ct||t===X)return t;const i=e.element,o=e.name;if(e.type===qt.PROPERTY){if(t===i[o])return Ct}else if(e.type===qt.BOOLEAN_ATTRIBUTE){if(!!t===i.hasAttribute(o))return Ct}else if(e.type===qt.ATTRIBUTE&&i.getAttribute(o)===t+"")return Ct;return Ta(e),t}});var nt=class extends A{constructor(){super(...arguments),this.formControlController=new ie(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new xt(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.indeterminate=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleClick(){this.checked=!this.checked,this.indeterminate=!1,this.emit("sl-change")}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleStateChange(){this.input.checked=this.checked,this.input.indeterminate=this.indeterminate,this.formControlController.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return h`
      <div
...
`;const ho=new Set,Ae=new Map;let fe,qo="ltr",Ko="en";const ir=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(ir){const e=new MutationObserver(sr);qo=document.documentElement.dir||"ltr",Ko=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function or(...e){e.map(t=>{const i=t.$code.toLowerCase();Ae.has(i)?Ae.set(i,Object.assign(Object.assign({},Ae.get(i)),t)):Ae.set(i,t),fe||(fe=t)}),sr()}function sr(){ir&&(qo=document.documentElement.dir||"ltr",Ko=document.documentElement.lang||navigator.language),[...ho.keys()].map(e=>{typeof e.requestUpdate=="function"&&e.requestUpdate()})}let Da=class{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){ho.add(this.host)}hostDisconnected(){ho.delete(this.host)}dir(){return`${this.host.dir||qo}`.toLowerCase()}lang(){return`${this.host.lang||Ko}`.toLowerCase()}getTranslationData(t){var i,o;const s=new Intl.Locale(t.replace(/_/g,"-")),r=s==null?void 0:s.language.toLowerCase(),n=(o=(i=s==null?void 0:s.region)===null||i===void 0?void 0:i.toLowerCase())!==null&&o!==void 0?o:"",l=Ae.get(`${r}-${n}`),d=Ae.get(r);return{locale:s,language:r,region:n,primary:l,secondary:d}}exists(t,i){var o;const{primary:s,secondary:r}=this.getTranslationData((o=i.lang)!==null&&o!==void 0?o:this.lang());return i=Object.assign({includeFallback:!1},i),!!(s&&s[t]||r&&r[t]||i.includeFallback&&fe&&fe[t])}term(t,...i){const{primary:o,secondary:s}=this.getTranslationData(this.lang());let r;if(o&&o[t])r=o[t];else if(s&&s[t])r=s[t];else if(fe&&fe[t])r=fe[t];else return console.error(`No translation found for: ${String(t)}`),String(t);return typeof r=="function"?r(...i):r}date(t,i){return t=new Date(t),new Intl.DateTimeFormat(this.lang(),i).format(t)}number(t,i){return t=Number(t),isNaN(t)?"":new Intl.NumberFormat(this.lang(),i).format(t)}relativeTime(t,i,o){return new Intl.RelativeTimeFormat(this.lang(),o).format(t,i)}};var rr={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:e=>e===0?"No options selected":e===1?"1 option selected":`${e} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:e=>`Slide ${e}`,toggleColorFormat:"Toggle color format"};or(rr);var La=rr,U=class extends Da{};or(La);var gi=class extends A{constructor(){super(...arguments),this.localize=new U(this)}render(){return h`
      <svg part="base" class="spinner" role="progressbar" aria-label=${this.localize.term("loading")}>
        <circle class="spinner__track"></circle>
        <circle class="spinner__indicator"></circle>
      </svg>
    `}};gi.styles=[P,Ia];var ar=new Map,Pa=new WeakMap;function Oa(e){return e??{keyframes:[],options:{duration:0}}}function ys(e,t){return t.toLowerCase()==="rtl"?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function j(e,t){ar.set(e,Oa(t))}function Y(e,t,i){const o=Pa.get(e);if(o!=null&&o[t])return ys(o[t],i.dir);const s=ar.get(t);return s?ys(s,i.dir):{keyframes:[],options:{duration:0}}}function J(e,t,i){return new Promise(o=>{if((i==null?void 0:i.duration)===1/0)throw new Error("Promise-based animations must be finite.");const s=e.animate(t,hi(ee({},i),{duration:po()?0:i.duration}));s.addEventListener("cancel",o,{once:!0}),s.addEventListener("finish",o,{once:!0})})}function xs(e){return e=e.toString().toLowerCase(),e.indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?parseFloat(e)*1e3:parseFloat(e)}function po(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function rt(e){return Promise.all(e.getAnimations().map(t=>new Promise(i=>{t.cancel(),requestAnimationFrame(i)})))}function Di(e,t){return e.map(i=>hi(ee({},i),{height:i.height==="auto"?`${t}px`:i.height}))}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ws(e,t,i){return e?t(e):i==null?void 0:i(e)}var tt=class uo extends A{constructor(){super(...arguments),this.localize=new U(this),this.indeterminate=!1,this.isLeaf=!1,this.loading=!1,this.selectable=!1,this.expanded=!1,this.selected=!1,this.disabled=!1,this.lazy=!1}static isTreeItem(t){return t instanceof Element&&t.getAttribute("role")==="treeitem"}connectedCallback(){super.connectedCallback(),this.setAttribute("role","treeitem"),this.setAttribute("tabindex","-1"),this.isNestedItem()&&(this.slot="children")}firstUpdated(){this.childrenContainer.hidden=!this.expanded,this.childrenContainer.style.height=this.expanded?"auto":"0",this.isLeaf=!this.lazy&&this.getChildrenItems().length===0,this.handleExpandedChange()}async animateCollapse(){this.emit("sl-collapse"),await rt(this.childrenContainer);const{keyframes:t,options:i}=Y(this,"tree-item.collapse",{dir:this.localize.dir()});await J(this.childrenContainer,Di(t,this.childrenContainer.scrollHeight),i),this.childrenContainer.hidden=!0,this.emit("sl-after-collapse")}isNestedItem(){const t=this.parentElement;return!!t&&uo.isTreeItem(t)}handleChildrenSlotChange(){this.loading=!1,this.isLeaf=!this.lazy&&this.getChildrenItems().length===0}willUpdate(t){t.has("selected")&&!t.has("indeterminate")&&(this.indeterminate=!1)}async animateExpand(){this.emit("sl-expand"),await rt(this.childrenContainer),this.childrenContainer.hidden=!1;const{keyframes:t,options:i}=Y(this,"tree-item.expand",{dir:this.localize.dir()});await J(this.childrenContainer,Di(t,this.childrenContainer.scrollHeight),i),this.childrenContainer.style.height="auto",this.emit("sl-after-expand")}handleLoadingChange(){this.setAttribute("aria-busy",this.loading?"true":"false"),this.loading||this.animateExpand()}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false")}handleSelectedChange(){this.setAttribute("aria-selected",this.selected?"true":"false")}handleExpandedChange(){this.isLeaf?this.removeAttribute("aria-expanded"):this.setAttribute("aria-expanded",this.expanded?"true":"false")}handleExpandAnimation(){this.expanded?this.lazy?(this.loading=!0,this.emit("sl-lazy-load")):this.animateExpand():this.animateCollapse()}handleLazyChange(){this.emit("sl-lazy-change")}getChildrenItems({includeDisabled:t=!0}={}){return this.childrenSlot?[...this.childrenSlot.assignedElements({flatten:!0})].filter(i=>uo.isTreeItem(i)&&(t||!i.disabled)):[]}render(){const t=this.localize.dir()==="rtl",i=!this.loading&&(!this.isLeaf||this.lazy);return h`
      <div
        part="base"
      ...
      >
        ...
        >
          ...
          <div
            ...
            aria-hidden="true"
          >
            ${ws(this.loading,()=>h` <sl-spinner part="spinner" exportparts="base:spinner__base"></sl-spinner> `)}
...
`;const ne=Math.min,$t=Math.max,Li=Math.round,ki=Math.floor,Kt=e=>({x:e,y:e}),Fa={left:"right",right:"left",bottom:"top",top:"bottom"},Ba={start:"end",end:"start"};function fo(e,t,i){return $t(e,ne(t,i))}function Me(e,t){return typeof e=="function"?e(t):e}function le(e){return e.split("-")[0]}function Fe(e){return e.split("-")[1]}function nr(e){return e==="x"?"y":"x"}function Go(e){return e==="y"?"height":"width"}const Va=new Set(["top","bottom"]);function te(e){return Va.has(le(e))?"y":"x"}function Xo(e){return nr(te(e))}function Ha(e,t,i){i===void 0&&(i=!1);const o=Fe(e),s=Xo(e),r=Go(s);let n=s==="x"?o===(i?"end":"start")?"right":"left":o==="start"?"bottom":"top";return t.reference[r]>t.floating[r]&&(n=Pi(n)),[n,Pi(n)]}function Ua(e){const t=Pi(e);return[go(e),t,go(t)]}function go(e){return e.replace(/start|end/g,t=>Ba[t])}const _s=["left","right"],ks=["right","left"],Na=["top","bottom"],ja=["bottom","top"];function Wa(e,t,i){switch(e){case"top":case"bottom":return i?t?ks:_s:t?_s:ks;case"left":case"right":return t?Na:ja;default:return[]}}function qa(e,t,i,o){const s=Fe(e);let r=Wa(le(e),i==="start",o);return s&&(r=r.map(n=>n+"-"+s),t&&(r=r.concat(r.map(go)))),r}function Pi(e){return e.replace(/left|right|bottom|top/g,t=>Fa[t])}function Ka(e){return{top:0,right:0,bottom:0,left:0,...e}}function lr(e){return typeof e!="number"?Ka(e):{top:e,right:e,bottom:e,left:e}}function Oi(e){const{x:t,y:i,width:o,height:s}=e;return{width:o,height:s,top:i,left:t,right:t+o,bottom:i+s,x:t,y:i}}function $s(e,t,i){let{reference:o,floating:s}=e;const r=te(t),n=Xo(t),l=Go(n),d=le(t),p=r==="y",g=o.x+o.width/2-s.width/2,u=o.y+o.height/2-s.height/2,f=o[l]/2-s[l]/2;let m;switch(d){case"top":m={x:g,y:o.y-s.height};break;case"bottom":m={x:g,y:o.y+o.height};break;case"right":m={x:o.x+o.width,y:u};break;case"left":m={x:o.x-s.width,y:u};break;default:m={x:o.x,y:o.y}}switch(Fe(t)){case"start":m[n]-=f*(i&&p?-1:1);break;case"end":m[n]+=f*(i&&p?-1:1);break}return m}async function Ga(e,t){var i;t===void 0&&(t={});const{x:o,y:s,platform:r,rects:n,elements:l,strategy:d}=e,{boundary:p="clippingAncestors",rootBoundary:g="viewport",elementContext:u="floating",altBoundary:f=!1,padding:m=0}=Me(t,e),b=lr(m),z=l[f?u==="floating"?"reference":"floating":u],T=Oi(await r.getClippingRect({element:(i=await(r.isElement==null?void 0:r.isElement(z)))==null||i?z:z.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(l.floating)),boundary:p,rootBoundary:g,strategy:d})),x=u==="floating"?{x:o,y:s,width:n.floating.width,height:n.floating.height}:n.reference,C=await(r.getOffsetParent==null?void 0:r.getOffsetParent(l.floating)),v=await(r.isElement==null?void 0:r.isElement(C))?await(r.getScale==null?void 0:r.getScale(C))||{x:1,y:1}:{x:1,y:1},w=Oi(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:x,offsetParent:C,strategy:d}):x);return{top:(T.top-w.top+b.top)/v.y,bottom:(w.bottom-T.bottom+b.bottom)/v.y,left:(T.left-w.left+b.left)/v.x,right:(w.right-T.right+b.right)/v.x}}const Xa=async(e,t,i)=>{const{placement:o="bottom",strategy:s="absolute",middleware:r=[],platform:n}=i,l=r.filter(Boolean),d=await(n.isRTL==null?void 0:n.isRTL(t));let p=await n.getElementRects({reference:e,floating:t,strategy:s}),{x:g,y:u}=$s(p,o,d),f=o,m={},b=0;for(let z=0;z<l.length;z++){var y;const{name:T,fn:x}=l[z],{x:C,y:v,data:w,reset:E}=await x({x:g,y:u,initialPlacement:o,placement:f,strategy:s,middlewareData:m,rects:p,platform:{...n,detectOverflow:(y=n.detectOverflow)!=null?y:Ga},elements:{reference:e,floating:t}});g=C??g,u=v??u,m={...m,[T]:{...m[T],...w}},E&&b<=50&&(b++,typeof E=="object"&&(E.placement&&(f=E.placement),E.rects&&(p=E.rects===!0?await n.getElementRects({reference:e,floating:t,strategy:s}):E.rects),{x:g,y:u}=$s(p,f,d)),z=-1)}return{x:g,y:u,placement:f,strategy:s,middlewareData:m}},Ya=e=>({name:"arrow",options:e,async fn(t){const{x:i,y:o,placement:s,rects:r,platform:n,elements:l,middlewareData:d}=t,{element:p,padding:g=0}=Me(e,t)||{};if(p==null)return{};const u=lr(g),f={x:i,y:o},m=Xo(s),b=Go(m),y=await n.getDimensions(p),z=m==="y",T=z?"top":"left",x=z?"bottom":"right",C=z?"clientHeight":"clientWidth",v=r.reference[b]+r.reference[m]-f[m]-r.floating[b],w=f[m]-r.reference[m],E=await(n.getOffsetParent==null?void 0:n.getOffsetParent(p));let M=E?E[C]:0;(!M||!await(n.isElement==null?void 0:n.isElement(E)))&&(M=l.floating[C]||r.floating[b]);const B=v/2-w/2,O=M/2-y[b]/2-1,I=ne(u[T],O),at=ne(u[x],O),it=I,mt=M-y[b]-at,ot=M/2-y[b]/2+B,Dt=fo(it,ot,mt),Wt=!d.arrow&&Fe(s)!=null&&ot!==Dt&&r.reference[b]/2-(ot<it?I:at)-y[b]/2<0,Ot=Wt?ot<it?ot-it:ot-mt:0;return{[m]:f[m]+Ot,data:{[m]:Dt,centerOffset:ot-Dt-Ot,...Wt&&{alignmentOffset:Ot}},reset:Wt}}}),Za=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var i,o;const{placement:s,middlewareData:r,rects:n,initialPlacement:l,platform:d,elements:p}=t,{mainAxis:g=!0,crossAxis:u=!0,fallbackPlacements:f,fallbackStrategy:m="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:y=!0,...z}=Me(e,t);if((i=r.arrow)!=null&&i.alignmentOffset)return{};const T=le(s),x=te(l),C=le(l)===l,v=await(d.isRTL==null?void 0:d.isRTL(p.floating)),w=f||(C||!y?[Pi(l)]:Ua(l)),E=b!=="none";!f&&E&&w.push(...qa(l,y,b,v));const M=[l,...w],B=await d.detectOverflow(t,z),O=[];let I=((o=r.flip)==null?void 0:o.overflows)||[];if(g&&O.push(B[T]),u){const ot=Ha(s,n,v);O.push(B[ot[0]],B[ot[1]])}if(I=[...I,{placement:s,overflows:O}],!O.every(ot=>ot<=0)){var at,it;const ot=(((at=r.flip)==null?void 0:at.index)||0)+1,Dt=M[ot];if(Dt&&(!(u==="alignment"?x!==te(Dt):!1)||I.every(Rt=>te(Rt.placement)===x?Rt.overflows[0]>0:!0)))return{data:{index:ot,overflows:I},reset:{placement:Dt}};let Wt=(it=I.filter(Ot=>Ot.overflows[0]<=0).sort((Ot,Rt)=>Ot.overflows[1]-Rt.overflows[1])[0])==null?void 0:it.placement;if(!Wt)switch(m){case"bestFit":{var mt;const Ot=(mt=I.filter(Rt=>{if(E){const oe=te(Rt.placement);return oe===x||oe==="y"}return!0}).map(Rt=>[Rt.placement,Rt.overflows.filter(oe=>oe>0).reduce((oe,Lr)=>oe+Lr,0)]).sort((Rt,oe)=>Rt[1]-oe[1])[0])==null?void 0:mt[0];Ot&&(Wt=Ot);break}case"initialPlacement":Wt=l;break}if(s!==Wt)return{reset:{placement:Wt}}}return{}}}},Qa=new Set(["left","top"]);async function Ja(e,t){const{placement:i,platform:o,elements:s}=e,r=await(o.isRTL==null?void 0:o.isRTL(s.floating)),n=le(i),l=Fe(i),d=te(i)==="y",p=Qa.has(n)?-1:1,g=r&&d?-1:1,u=Me(t,e);let{mainAxis:f,crossAxis:m,alignmentAxis:b}=typeof u=="number"?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:u.mainAxis||0,crossAxis:u.crossAxis||0,alignmentAxis:u.alignmentAxis};return l&&typeof b=="number"&&(m=l==="end"?b*-1:b),d?{x:m*g,y:f*p}:{x:f*p,y:m*g}}const tn=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(t){var i,o;const{x:s,y:r,placement:n,middlewareData:l}=t,d=await Ja(t,e);return n===((i=l.offset)==null?void 0:i.placement)&&(o=l.arrow)!=null&&o.alignmentOffset?{}:{x:s+d.x,y:r+d.y,data:{...d,placement:n}}}}},en=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:i,y:o,placement:s,platform:r}=t,{mainAxis:n=!0,crossAxis:l=!1,limiter:d={fn:T=>{let{x,y:C}=T;return{x,y:C}}},...p}=Me(e,t),g={x:i,y:o},u=await r.detectOverflow(t,p),f=te(le(s)),m=nr(f);let b=g[m],y=g[f];if(n){const T=m==="y"?"top":"left",x=m==="y"?"bottom":"right",C=b+u[T],v=b-u[x];b=fo(C,b,v)}if(l){const T=f==="y"?"top":"left",x=f==="y"?"bottom":"right",C=y+u[T],v=y-u[x];y=fo(C,y,v)}const z=d.fn({...t,[m]:b,[f]:y});return{...z,data:{x:z.x-i,y:z.y-o,enabled:{[m]:n,[f]:l}}}}}},on=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var i,o;const{placement:s,rects:r,platform:n,elements:l}=t,{apply:d=()=>{},...p}=Me(e,t),g=await n.detectOverflow(t,p),u=le(s),f=Fe(s),m=te(s)==="y",{width:b,height:y}=r.floating;let z,T;u==="top"||u==="bottom"?(z=u,T=f===(await(n.isRTL==null?void 0:n.isRTL(l.floating))?"start":"end")?"left":"right"):(T=u,z=f==="end"?"top":"bottom");const x=y-g.top-g.bottom,C=b-g.left-g.right,v=ne(y-g[z],x),w=ne(b-g[T],C),E=!t.middlewareData.shift;let M=v,B=w;if((i=t.middlewareData.shift)!=null&&i.enabled.x&&(B=C),(o=t.middlewareData.shift)!=null&&o.enabled.y&&(M=x),E&&!f){const I=$t(g.left,0),at=$t(g.right,0),it=$t(g.top,0),mt=$t(g.bottom,0);m?B=b-2*(I!==0||at!==0?I+at:$t(g.left,g.right)):M=y-2*(it!==0||mt!==0?it+mt:$t(g.top,g.bottom))}await d({...t,availableWidth:B,availableHeight:M});const O=await n.getDimensions(l.floating);return b!==O.width||y!==O.height?{reset:{rects:!0}}:{}}}};function Vi(){return typeof window<"u"}function Be(e){return cr(e)?(e.nodeName||"").toLowerCase():"#document"}function zt(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function Xt(e){var t;return(t=(cr(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function cr(e){return Vi()?e instanceof Node||e instanceof zt(e).Node:!1}function Mt(e){return Vi()?e instanceof Element||e instanceof zt(e).Element:!1}function Gt(e){return Vi()?e instanceof HTMLElement||e instanceof zt(e).HTMLElement:!1}function Cs(e){return!Vi()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof zt(e).ShadowRoot}const sn=new Set(["inline","contents"]);function mi(e){const{overflow:t,overflowX:i,overflowY:o,display:s}=Ft(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+i)&&!sn.has(s)}const rn=new Set(["table","td","th"]);function an(e){return rn.has(Be(e))}const nn=[":popover-open",":modal"];function Hi(e){return nn.some(t=>{try{return e.matches(t)}catch{return!1}})}const ln=["transform","translate","scale","rotate","perspective"],cn=["transform","translate","scale","rotate","perspective","filter"],dn=["paint","layout","strict","content"];function Ui(e){const t=Yo(),i=Mt(e)?Ft(e):e;return ln.some(o=>i[o]?i[o]!=="none":!1)||(i.containerType?i.containerType!=="normal":!1)||!t&&(i.backdropFilter?i.backdropFilter!=="none":!1)||!t&&(i.filter?i.filter!=="none":!1)||cn.some(o=>(i.willChange||"").includes(o))||dn.some(o=>(i.contain||"").includes(o))}function hn(e){let t=ce(e);for(;Gt(t)&&!Oe(t);){if(Ui(t))return t;if(Hi(t))return null;t=ce(t)}return null}function Yo(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}const pn=new Set(["html","body","#document"]);function Oe(e){return pn.has(Be(e))}function Ft(e){return zt(e).getComputedStyle(e)}function Ni(e){return Mt(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function ce(e){if(Be(e)==="html")return e;const t=e.assignedSlot||e.parentNode||Cs(e)&&e.host||Xt(e);return Cs(t)?t.host:t}function dr(e){const t=ce(e);return Oe(t)?e.ownerDocument?e.ownerDocument.body:e.body:Gt(t)&&mi(t)?t:dr(t)}function li(e,t,i){var o;t===void 0&&(t=[]),i===void 0&&(i=!0);const s=dr(e),r=s===((o=e.ownerDocument)==null?void 0:o.body),n=zt(s);if(r){const l=mo(n);return t.concat(n,n.visualViewport||[],mi(s)?s:[],l&&i?li(l):[])}return t.concat(s,li(s,[],i))}function mo(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function hr(e){const t=Ft(e);let i=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const s=Gt(e),r=s?e.offsetWidth:i,n=s?e.offsetHeight:o,l=Li(i)!==r||Li(o)!==n;return l&&(i=r,o=n),{width:i,height:o,$:l}}function Zo(e){return Mt(e)?e:e.contextElement}function De(e){const t=Zo(e);if(!Gt(t))return Kt(1);const i=t.getBoundingClientRect(),{width:o,height:s,$:r}=hr(t);let n=(r?Li(i.width):i.width)/o,l=(r?Li(i.height):i.height)/s;return(!n||!Number.isFinite(n))&&(n=1),(!l||!Number.isFinite(l))&&(l=1),{x:n,y:l}}const un=Kt(0);function pr(e){const t=zt(e);return!Yo()||!t.visualViewport?un:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function fn(e,t,i){return t===void 0&&(t=!1),!i||t&&i!==zt(e)?!1:t}function xe(e,t,i,o){t===void 0&&(t=!1),i===void 0&&(i=!1);const s=e.getBoundingClientRect(),r=Zo(e);let n=Kt(1);t&&(o?Mt(o)&&(n=De(o)):n=De(e));const l=fn(r,i,o)?pr(r):Kt(0);let d=(s.left+l.x)/n.x,p=(s.top+l.y)/n.y,g=s.width/n.x,u=s.height/n.y;if(r){const f=zt(r),m=o&&Mt(o)?zt(o):o;let b=f,y=mo(b);for(;y&&o&&m!==b;){const z=De(y),T=y.getBoundingClientRect(),x=Ft(y),C=T.left+(y.clientLeft+parseFloat(x.paddingLeft))*z.x,v=T.top+(y.clientTop+parseFloat(x.paddingTop))*z.y;d*=z.x,p*=z.y,g*=z.x,u*=z.y,d+=C,p+=v,b=zt(y),y=mo(b)}}return Oi({width:g,height:u,x:d,y:p})}function ji(e,t){const i=Ni(e).scrollLeft;return t?t.left+i:xe(Xt(e)).left+i}function ur(e,t){const i=e.getBoundingClientRect(),o=i.left+t.scrollLeft-ji(e,i),s=i.top+t.scrollTop;return{x:o,y:s}}function gn(e){let{elements:t,rect:i,offsetParent:o,strategy:s}=e;const r=s==="fixed",n=Xt(o),l=t?Hi(t.floating):!1;if(o===n||l&&r)return i;let d={scrollLeft:0,scrollTop:0},p=Kt(1);const g=Kt(0),u=Gt(o);if((u||!u&&!r)&&((Be(o)!=="body"||mi(n))&&(d=Ni(o)),Gt(o))){const m=xe(o);p=De(o),g.x=m.x+o.clientLeft,g.y=m.y+o.clientTop}const f=n&&!u&&!r?ur(n,d):Kt(0);return{width:i.width*p.x,height:i.height*p.y,x:i.x*p.x-d.scrollLeft*p.x+g.x+f.x,y:i.y*p.y-d.scrollTop*p.y+g.y+f.y}}function mn(e){return Array.from(e.getClientRects())}function bn(e){const t=Xt(e),i=Ni(e),o=e.ownerDocument.body,s=$t(t.scrollWidth,t.clientWidth,o.scrollWidth,o.clientWidth),r=$t(t.scrollHeight,t.clientHeight,o.scrollHeight,o.clientHeight);let n=-i.scrollLeft+ji(e);const l=-i.scrollTop;return Ft(o).direction==="rtl"&&(n+=$t(t.clientWidth,o.clientWidth)-s),{width:s,height:r,x:n,y:l}}const zs=25;function vn(e,t){const i=zt(e),o=Xt(e),s=i.visualViewport;let r=o.clientWidth,n=o.clientHeight,l=0,d=0;if(s){r=s.width,n=s.height;const g=Yo();(!g||g&&t==="fixed")&&(l=s.offsetLeft,d=s.offsetTop)}const p=ji(o);if(p<=0){const g=o.ownerDocument,u=g.body,f=getComputedStyle(u),m=g.compatMode==="CSS1Compat"&&parseFloat(f.marginLeft)+parseFloat(f.marginRight)||0,b=Math.abs(o.clientWidth-u.clientWidth-m);b<=zs&&(r-=b)}else p<=zs&&(r+=p);return{width:r,height:n,x:l,y:d}}const yn=new Set(["absolute","fixed"]);function xn(e,t){const i=xe(e,!0,t==="fixed"),o=i.top+e.clientTop,s=i.left+e.clientLeft,r=Gt(e)?De(e):Kt(1),n=e.clientWidth*r.x,l=e.clientHeight*r.y,d=s*r.x,p=o*r.y;return{width:n,height:l,x:d,y:p}}function Ss(e,t,i){let o;if(t==="viewport")o=vn(e,i);else if(t==="document")o=bn(Xt(e));else if(Mt(t))o=xn(t,i);else{const s=pr(e);o={x:t.x-s.x,y:t.y-s.y,width:t.width,height:t.height}}return Oi(o)}function fr(e,t){const i=ce(e);return i===t||!Mt(i)||Oe(i)?!1:Ft(i).position==="fixed"||fr(i,t)}function wn(e,t){const i=t.get(e);if(i)return i;let o=li(e,[],!1).filter(l=>Mt(l)&&Be(l)!=="body"),s=null;const r=Ft(e).position==="fixed";let n=r?ce(e):e;for(;Mt(n)&&!Oe(n);){const l=Ft(n),d=Ui(n);!d&&l.position==="fixed"&&(s=null),(r?!d&&!s:!d&&l.position==="static"&&!!s&&yn.has(s.position)||mi(n)&&!d&&fr(e,n))?o=o.filter(g=>g!==n):s=l,n=ce(n)}return t.set(e,o),o}function _n(e){let{element:t,boundary:i,rootBoundary:o,strategy:s}=e;const n=[...i==="clippingAncestors"?Hi(t)?[]:wn(t,this._c):[].concat(i),o],l=n[0],d=n.reduce((p,g)=>{const u=Ss(t,g,s);return p.top=$t(u.top,p.top),p.right=ne(u.right,p.right),p.bottom=ne(u.bottom,p.bottom),p.left=$t(u.left,p.left),p},Ss(t,l,s));return{width:d.right-d.left,height:d.bottom-d.top,x:d.left,y:d.top}}function kn(e){const{width:t,height:i}=hr(e);return{width:t,height:i}}function $n(e,t,i){const o=Gt(t),s=Xt(t),r=i==="fixed",n=xe(e,!0,r,t);let l={scrollLeft:0,scrollTop:0};const d=Kt(0);function p(){d.x=ji(s)}if(o||!o&&!r)if((Be(t)!=="body"||mi(s))&&(l=Ni(t)),o){const m=xe(t,!0,r,t);d.x=m.x+t.clientLeft,d.y=m.y+t.clientTop}else s&&p();r&&!o&&s&&p();const g=s&&!o&&!r?ur(s,l):Kt(0),u=n.left+l.scrollLeft-d.x-g.x,f=n.top+l.scrollTop-d.y-g.y;return{x:u,y:f,width:n.width,height:n.height}}function eo(e){return Ft(e).position==="static"}function As(e,t){if(!Gt(e)||Ft(e).position==="fixed")return null;if(t)return t(e);let i=e.offsetParent;return Xt(e)===i&&(i=i.ownerDocument.body),i}function gr(e,t){const i=zt(e);if(Hi(e))return i;if(!Gt(e)){let s=ce(e);for(;s&&!Oe(s);){if(Mt(s)&&!eo(s))return s;s=ce(s)}return i}let o=As(e,t);for(;o&&an(o)&&eo(o);)o=As(o,t);return o&&Oe(o)&&eo(o)&&!Ui(o)?i:o||hn(e)||i}const Cn=async function(e){const t=this.getOffsetParent||gr,i=this.getDimensions,o=await i(e.floating);return{reference:$n(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}};function zn(e){return Ft(e).direction==="rtl"}const Ti={convertOffsetParentRelativeRectToViewportRelativeRect:gn,getDocumentElement:Xt,getClippingRect:_n,getOffsetParent:gr,getElementRects:Cn,getClientRects:mn,getDimensions:kn,getScale:De,isElement:Mt,isRTL:zn};function mr(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function Sn(e,t){let i=null,o;const s=Xt(e);function r(){var l;clearTimeout(o),(l=i)==null||l.disconnect(),i=null}function n(l,d){l===void 0&&(l=!1),d===void 0&&(d=1),r();const p=e.getBoundingClientRect(),{left:g,top:u,width:f,height:m}=p;if(l||t(),!f||!m)return;const b=ki(u),y=ki(s.clientWidth-(g+f)),z=ki(s.clientHeight-(u+m)),T=ki(g),C={rootMargin:-b+"px "+-y+"px "+-z+"px "+-T+"px",threshold:$t(0,ne(1,d))||1};let v=!0;function w(E){const M=E[0].intersectionRatio;if(M!==d){if(!v)return n();M?n(!1,M):o=setTimeout(()=>{n(!1,1e-7)},1e3)}M===1&&!mr(p,e.getBoundingClientRect())&&n(),v=!1}try{i=new IntersectionObserver(w,{...C,root:s.ownerDocument})}catch{i=new IntersectionObserver(w,C)}i.observe(e)}return n(!0),r}function An(e,t,i,o){o===void 0&&(o={});const{ancestorScroll:s=!0,ancestorResize:r=!0,elementResize:n=typeof ResizeObserver=="function",layoutShift:l=typeof IntersectionObserver=="function",animationFrame:d=!1}=o,p=Zo(e),g=s||r?[...p?li(p):[],...li(t)]:[];g.forEach(T=>{s&&T.addEventListener("scroll",i,{passive:!0}),r&&T.addEventListener("resize",i)});const u=p&&l?Sn(p,i):null;let f=-1,m=null;n&&(m=new ResizeObserver(T=>{let[x]=T;x&&x.target===p&&m&&(m.unobserve(t),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var C;(C=m)==null||C.observe(t)})),i()}),p&&!d&&m.observe(p),m.observe(t));let b,y=d?xe(e):null;d&&z();function z(){const T=xe(e);y&&!mr(y,T)&&i(),y=T,b=requestAnimationFrame(z)}return i(),()=>{var T;g.forEach(x=>{s&&x.removeEventListener("scroll",i),r&&x.removeEventListener("resize",i)}),u==null||u(),(T=m)==null||T.disconnect(),m=null,d&&cancelAnimationFrame(b)}}const En=tn,Tn=en,In=Za,Es=on,Dn=Ya,Ln=(e,t,i)=>{const o=new Map,s={platform:Ti,...i},r={...s.platform,_c:o};return Xa(e,t,{...s,platform:r})};function Pn(e){return On(e)}function io(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function On(e){for(let t=e;t;t=io(t))if(t instanceof Element&&getComputedStyle(t).display==="none")return null;for(let t=io(e);t;t=io(t)){if(!(t instanceof Element))continue;const i=getComputedStyle(t);if(i.display!=="contents"&&(i.position!=="static"||Ui(i)||t.tagName==="BODY"))return t}return null}function Rn(e){return e!==null&&typeof e=="object"&&"getBoundingClientRect"in e&&("contextElement"in e?e.contextElement instanceof Element:!0)}var W=class extends A{constructor(){super(...arguments),this.localize=new U(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom");let o=0,s=0,r=0,n=0,l=0,d=0,p=0,g=0;i?e.top<t.top?(o=e.left,s=e.bottom,r=e.right,n=e.bottom,l=t.left,d=t.top,p=t.right,g=t.top):(o=t.left,s=t.bottom,r=t.right,n=t.bottom,l=e.left,d=e.top,p=e.right,g=e.top):e.left<t.left?(o=e.right,s=e.top,r=t.left,n=t.top,l=e.right,d=e.bottom,p=t.left,g=t.bottom):(o=t.right,s=t.top,r=e.left,n=e.top,l=t.right,d=t.bottom,p=e.left,g=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${s}px`),this.style.setProperty("--hover-bridge-top-right-x",`${r}px`),this.style.setProperty("--hover-bridge-top-right-y",`${n}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${p}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${g}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||Rn(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=An(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;const e=[En({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Es({apply:({rects:i})=>{const o=this.sync==="width"||this.sync==="both",s=this.sync==="height"||this.sync==="both";this.popup.style.width=o?`${i.reference.width}px`:"",this.popup.style.height=s?`${i.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(In({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(Tn({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(Es({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:i,availableHeight:o})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${o}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${i}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(Dn({element:this.arrowEl,padding:this.arrowPadding}));const t=this.strategy==="absolute"?i=>Ti.getOffsetParent(i,Pn):Ti.getOffsetParent;Ln(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:hi(ee({},Ti),{getOffsetParent:t})}).then(({x:i,y:o,middlewareData:s,placement:r})=>{const n=this.localize.dir()==="rtl",l={top:"bottom",right:"left",bottom:"top",left:"right"}[r.split("-")[0]];if(this.setAttribute("data-current-placement",r),Object.assign(this.popup.style,{left:`${i}px`,top:`${o}px`}),this.arrow){const d=s.arrow.x,p=s.arrow.y;let g="",u="",f="",m="";if(this.arrowPlacement==="start"){const b=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";g=typeof p=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",u=n?b:"",m=n?"":b}else if(this.arrowPlacement==="end"){const b=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";u=n?"":b,m=n?b:"",f=typeof p=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(m=typeof d=="number"?"calc(50% - var(--arrow-size-diagonal))":"",g=typeof p=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(m=typeof d=="number"?`${d}px`:"",g=typeof p=="number"?`${p}px`:"");Object.assign(this.arrowEl.style,{top:g,right:u,bottom:f,left:m,[l]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return h`
...
`;function st(e,t,i){const o=s=>Object.is(s,-0)?0:s;return e<t?o(t):e>i?o(i):o(e)}function Ts(e,t=!1){function i(r){const n=r.getChildrenItems({includeDisabled:!1});if(n.length){const l=n.every(p=>p.selected),d=n.every(p=>!p.selected&&!p.indeterminate);r.selected=l,r.indeterminate=!l&&!d}}function o(r){const n=r.parentElement;Qe.isTreeItem(n)&&(i(n),o(n))}function s(r){for(const n of r.getChildrenItems())n.selected=t?r.selected||n.selected:!n.disabled&&r.selected,s(n);t&&i(r)}s(e),o(e)}var _e=class extends A{constructor(){super(),this.selection="single",this.clickTarget=null,this.localize=new U(this),this.initTreeItem=e=>{e.selectable=this.selection==="multiple",["expand","collapse"].filter(t=>!!this.querySelector(`[slot="${t}-icon"]`)).forEach(t=>{const i=e.querySelector(`[slot="${t}-icon"]`),o=this.getExpandButtonIcon(t);o&&(i===null?e.append(o):i.hasAttribute("data-default")&&i.replaceWith(o))})},this.handleTreeChanged=e=>{for(const t of e){const i=[...t.addedNodes].filter(Qe.isTreeItem),o=[...t.removedNodes].filter(Qe.isTreeItem);i.forEach(this.initTreeItem),this.lastFocusedItem&&o.includes(this.lastFocusedItem)&&(this.lastFocusedItem=null)}},this.handleFocusOut=e=>{const t=e.relatedTarget;(!t||!this.contains(t))&&(this.tabIndex=0)},this.handleFocusIn=e=>{const t=e.target;e.target===this&&this.focusItem(this.lastFocusedItem||this.getAllTreeItems()[0]),Qe.isTreeItem(t)&&!t.disabled&&(this.lastFocusedItem&&(this.lastFocusedItem.tabIndex=-1),this.lastFocusedItem=t,this.tabIndex=-1,t.tabIndex=0)},this.addEventListener("focusin",this.handleFocusIn),this.addEventListener("focusout",this.handleFocusOut),this.addEventListener("sl-lazy-change",this.handleSlotChange)}async connectedCallback(){super.connectedCallback(),this.setAttribute("role","tree"),this.setAttribute("tabindex","0"),await this.updateComplete,this.mutationObserver=new MutationObserver(this.handleTreeChanged),this.mutationObserver.observe(this,{childList:!0,subtree:!0})}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.mutationObserver)==null||e.disconnect()}getExpandButtonIcon(e){const i=(e==="expand"?this.expandedIconSlot:this.collapsedIconSlot).assignedElements({flatten:!0})[0];if(i){const o=i.cloneNode(!0);return[o,...o.querySelectorAll("[id]")].forEach(s=>s.removeAttribute("id")),o.setAttribute("data-default",""),o.slot=`${e}-icon`,o}return null}selectItem(e){const t=[...this.selectedItems];if(this.selection==="multiple")e.selected=!e.selected,e.lazy&&(e.expanded=!0),Ts(e);else if(this.selection==="single"||e.isLeaf){const o=this.getAllTreeItems();for(const s of o)s.selected=s===e}else this.selection==="leaf"&&(e.expanded=!e.expanded);const i=this.selectedItems;(t.length!==i.length||i.some(o=>!t.includes(o)))&&Promise.all(i.map(o=>o.updateComplete)).then(()=>{this.emit("sl-selection-change",{detail:{selection:i}})})}getAllTreeItems(){return[...this.querySelectorAll("sl-tree-item")]}focusItem(e){e==null||e.focus()}handleKeyDown(e){if(!["ArrowDown","ArrowUp","ArrowRight","ArrowLeft","Home","End","Enter"," "].includes(e.key)||e.composedPath().some(s=>{var r;return["input","textarea"].includes((r=s==null?void 0:s.tagName)==null?void 0:r.toLowerCase())}))return;const t=this.getFocusableItems(),i=this.localize.dir()==="ltr",o=this.localize.dir()==="rtl";if(t.length>0){e.preventDefault();const s=t.findIndex(d=>d.matches(":focus")),r=t[s],n=d=>{const p=t[st(d,0,t.length-1)];this.focusItem(p)},l=d=>{r.expanded=d};e.key==="ArrowDown"?n(s+1):e.key==="ArrowUp"?n(s-1):i&&e.key==="ArrowRight"||o&&e.key==="ArrowLeft"?!r||r.disabled||r.expanded||r.isLeaf&&!r.lazy?n(s+1):l(!0):i&&e.key==="ArrowLeft"||o&&e.key==="ArrowRight"?!r||r.disabled||r.isLeaf||!r.expanded?n(s-1):l(!1):e.key==="Home"?n(0):e.key==="End"?n(t.length-1):(e.key==="Enter"||e.key===" ")&&(r.disabled||this.selectItem(r))}}handleClick(e){const t=e.target,i=t.closest("sl-tree-item"),o=e.composedPath().some(s=>{var r;return(r=s==null?void 0:s.classList)==null?void 0:r.contains("tree-item__expand-button")});!i||i.disabled||t!==this.clickTarget||(o?i.expanded=!i.expanded:this.selectItem(i))}handleMouseDown(e){this.clickTarget=e.target}handleSlotChange(){this.getAllTreeItems().forEach(this.initTreeItem)}async handleSelectionChange(){const e=this.selection==="multiple",t=this.getAllTreeItems();this.setAttribute("aria-multiselectable",e?"true":"false");for(const i of t)i.selectable=e;e&&(await this.updateComplete,[...this.querySelectorAll(":scope > sl-tree-item")].forEach(i=>Ts(i,!0)))}get selectedItems(){const e=this.getAllTreeItems(),t=i=>i.selected;return e.filter(t)}getFocusableItems(){const e=this.getAllTreeItems(),t=new Set;return e.filter(i=>{var o;if(i.disabled)return!1;const s=(o=i.parentElement)==null?void 0:o.closest("[role=treeitem]");return s&&(!s.expanded||s.loading||t.has(s))&&t.add(i),!t.has(i)})}render(){return h`
      <div
        part="base"
        class="tree"
        @click=${this.handleClick}
...
`,Qo=class extends A{render(){return h` <slot></slot> `}};Qo.styles=[P,Fn];Qo.define("sl-visually-hidden");var Bn=k`
  :host {
    --padding: 0;
...
`,Vn=0,bi=class extends A{constructor(){super(...arguments),this.attrId=++Vn,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return h`
      <slot
        part="base"
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const br=Symbol.for(""),Nn=e=>{if((e==null?void 0:e.r)===br)return e==null?void 0:e._$litStatic$},Ri=(e,...t)=>({_$litStatic$:t.reduce((i,o,s)=>i+(r=>{if(r._$litStatic$!==void 0)return r._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${r}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(o)+e[s+1],e[0]),r:br}),Is=new Map,jn=e=>(t,...i)=>{const o=i.length;let s,r;const n=[],l=[];let d,p=0,g=!1;for(;p<o;){for(d=t[p];p<o&&(r=i[p],(s=Nn(r))!==void 0);)d+=s+t[++p],g=!0;p!==o&&l.push(r),n.push(d),p++}if(p===o&&n.push(t[o]),g){const u=n.join("$$lit$$");(t=Is.get(u))===void 0&&(n.raw=n,Is.set(u,t=n)),i=l}return e(t,...i)},Je=jn(h);var lt=class extends A{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){const e=!!this.href,t=e?Ri`a`:Ri`button`;return Je`
      <${t}
        part="base"
    ...
    `}};lt.styles=[P,Un];lt.dependencies={"sl-icon":K};a([$(".icon-button")],lt.prototype,"button",2);a([D()],lt.prototype,"hasFocus",2);a([c()],lt.prototype,"name",2);a([c()],lt.prototype,"library",2);a([c()],lt.prototype,"src",2);a([c()],lt.prototype,"href",2);a([c()],lt.prototype,"target",2);a([c()],lt.prototype,"download",2);a([c()],lt.prototype,"label",2);a([c({type:Boolean,reflect:!0})],lt.prototype,"disabled",2);var de=class extends A{constructor(){super(...arguments),this.localize=new U(this),this.variant="neutral",this.size="medium",this.pill=!1,this.removable=!1}handleRemoveClick(){this.emit("sl-remove")}render(){return h`
      <span
        part="base"
...
`,Jo=class extends A{constructor(){super(...arguments),this.effect="none"}render(){return h`
      <div
        part="base"
    ...
    `}};Jo.styles=[P,Jn];a([c()],Jo.prototype,"effect",2);Jo.define("sl-skeleton");var tl=k`
  :host {
    --divider-width: 4px;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let yo=class extends fi{constructor(t){if(super(t),this.it=X,t.type!==qt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===X||t==null)return this._t=void 0,this.it=t;if(t===Ct)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const i=[t];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}};yo.directiveName="unsafeHTML",yo.resultType=1;const oi=ui(yo);var V=class extends A{constructor(){super(...arguments),this.formControlController=new ie(this,{assumeInteractionOn:["sl-blur","sl-input"]}),this.hasSlotController=new xt(this,"help-text","label"),this.localize=new U(this),this.typeToSelectString="",this.hasFocus=!1,this.displayLabel="",this.selectedOptions=[],this.valueHasChanged=!1,this.name="",this._value="",this.defaultValue="",this.size="medium",this.placeholder="",this.multiple=!1,this.maxOptionsVisible=3,this.disabled=!1,this.clearable=!1,this.open=!1,this.hoist=!1,this.filled=!1,this.pill=!1,this.label="",this.placement="bottom",this.helpText="",this.form="",this.required=!1,this.getTag=e=>h`
      <sl-tag
        part="tag"
        exportparts="
              base:tag__base,
...
`,Z=class extends A{constructor(){super(...arguments),this.formControlController=new ie(this),this.hasSlotController=new xt(this,"help-text","label"),this.localize=new U(this),this.hasFocus=!1,this.hasTooltip=!1,this.title="",this.name="",this.value=0,this.label="",this.helpText="",this.disabled=!1,this.min=0,this.max=100,this.step=1,this.tooltip="top",this.tooltipFormatter=e=>e.toString(),this.form="",this.defaultValue=0}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.syncRange()),this.value<this.min&&(this.value=this.min),this.value>this.max&&(this.value=this.max),this.updateComplete.then(()=>{this.syncRange(),this.resizeObserver.observe(this.input)})}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.resizeObserver)==null||e.unobserve(this.input)}handleChange(){this.emit("sl-change")}handleInput(){this.value=parseFloat(this.input.value),this.emit("sl-input"),this.syncRange()}handleBlur(){this.hasFocus=!1,this.hasTooltip=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.hasTooltip=!0,this.emit("sl-focus")}handleThumbDragStart(){this.hasTooltip=!0}handleThumbDragEnd(){this.hasTooltip=!1}syncProgress(e){this.input.style.setProperty("--percent",`${e*100}%`)}syncTooltip(e){if(this.output!==null){const t=this.input.offsetWidth,i=this.output.offsetWidth,o=getComputedStyle(this.input).getPropertyValue("--thumb-size"),s=this.localize.dir()==="rtl",r=t*e;if(s){const n=`${t-r}px + ${e} * ${o}`;this.output.style.translate=`calc((${n} - ${i/2}px - ${o} / 2))`}else{const n=`${r}px - ${e} * ${o}`;this.output.style.translate=`calc(${n} - ${i/2}px + ${o} / 2)`}}}handleValueChange(){this.formControlController.updateValidity(),this.input.value=this.value.toString(),this.value=parseFloat(this.input.value),this.syncRange()}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}syncRange(){const e=Math.max(0,(this.value-this.min)/(this.max-this.min));this.syncProgress(e),this.tooltip!=="none"&&this.hasTooltip&&this.updateComplete.then(()=>this.syncTooltip(e))}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}focus(e){this.input.focus(e)}blur(){this.input.blur()}stepUp(){this.input.stepUp(),this.value!==Number(this.input.value)&&(this.value=Number(this.input.value))}stepDown(){this.input.stepDown(),this.value!==Number(this.input.value)&&(this.value=Number(this.input.value))}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){const e=this.hasSlotController.test("label"),t=this.hasSlotController.test("help-text"),i=this.label?!0:!!e,o=this.helpText?!0:!!t;return h`
    ...
    `}};Z.styles=[P,we,ol];a([$(".range__control")],Z.prototype,"input",2);a([$(".range__tooltip")],Z.prototype,"output",2);a([D()],Z.prototype,"hasFocus",2);a([D()],Z.prototype,"hasTooltip",2);a([c()],Z.prototype,"title",2);a([c()],Z.prototype,"name",2);a([c({type:Number})],Z.prototype,"value",2);a([c()],Z.prototype,"label",2);a([c({attribute:"help-text"})],Z.prototype,"helpText",2);a([c({type:Boolean,reflect:!0})],Z.prototype,"disabled",2);a([c({type:Number})],Z.prototype,"min",2);a([c({type:Number})],Z.prototype,"max",2);a([c({type:Number})],Z.prototype,"step",2);a([c()],Z.prototype,"tooltip",2);a([c({attribute:!1})],Z.prototype,"tooltipFormatter",2);a([c({reflect:!0})],Z.prototype,"form",2);a([Re()],Z.prototype,"defaultValue",2);a([pi({passive:!0})],Z.prototype,"handleThumbDragStart",1);a([_("value",{waitUntilFirstUpdate:!0})],Z.prototype,"handleValueChange",1);a([_("disabled",{waitUntilFirstUpdate:!0})],Z.prototype,"handleDisabledChange",1);a([_("hasTooltip",{waitUntilFirstUpdate:!0})],Z.prototype,"syncRange",1);Z.define("sl-range");var sl=k`
  :host {
...
`,Ve=class extends A{constructor(){super(...arguments),this.localize=new U(this),this.value=0,this.label=""}updated(e){if(super.updated(e),e.has("value")){const t=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),i=2*Math.PI*t,o=i-this.value/100*i;this.indicatorOffset=`${o}px`}}render(){return h`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
...
`;let xr=null;class wr{}wr.render=function(e,t){xr(e,t)};self.QrCreator=wr;(function(e){function t(l,d,p,g){var u={},f=e(p,d);f.u(l),f.J(),g=g||0;var m=f.h(),b=f.h()+2*g;return u.text=l,u.level=d,u.version=p,u.O=b,u.a=function(y,z){return y-=g,z-=g,0>y||y>=m||0>z||z>=m?!1:f.a(y,z)},u}function i(l,d,p,g,u,f,m,b,y,z){function T(x,C,v,w,E,M,B){x?(l.lineTo(C+M,v+B),l.arcTo(C,v,w,E,f)):l.lineTo(C,v)}m?l.moveTo(d+f,p):l.moveTo(d,p),T(b,g,p,g,u,-f,0),T(y,g,u,d,u,0,-f),T(z,d,u,d,p,f,0),T(m,d,p,g,p,0,f)}function o(l,d,p,g,u,f,m,b,y,z){function T(x,C,v,w){l.moveTo(x+v,C),l.lineTo(x,C),l.lineTo(x,C+w),l.arcTo(x,C,x+v,C,f)}m&&T(d,p,f,f),b&&T(g,p,-f,f),y&&T(g,u,-f,-f),z&&T(d,u,f,-f)}function s(l,d){var p=d.fill;if(typeof p=="string")l.fillStyle=p;else{var g=p.type,u=p.colorStops;if(p=p.position.map(m=>Math.round(m*d.size)),g==="linear-gradient")var f=l.createLinearGradient.apply(l,p);else if(g==="radial-gradient")f=l.createRadialGradient.apply(l,p);else throw Error("Unsupported fill");u.forEach(([m,b])=>{f.addColorStop(m,b)}),l.fillStyle=f}}function r(l,d){t:{var p=d.text,g=d.v,u=d.N,f=d.K,m=d.P;for(u=Math.max(1,u||1),f=Math.min(40,f||40);u<=f;u+=1)try{var b=t(p,g,u,m);break t}catch{}b=void 0}if(!b)return null;for(p=l.getContext("2d"),d.background&&(p.fillStyle=d.background,p.fillRect(d.left,d.top,d.size,d.size)),g=b.O,f=d.size/g,p.beginPath(),m=0;m<g;m+=1)for(u=0;u<g;u+=1){var y=p,z=d.left+u*f,T=d.top+m*f,x=m,C=u,v=b.a,w=z+f,E=T+f,M=x-1,B=x+1,O=C-1,I=C+1,at=Math.floor(Math.min(.5,Math.max(0,d.R))*f),it=v(x,C),mt=v(M,O),ot=v(M,C);M=v(M,I);var Dt=v(x,I);I=v(B,I),C=v(B,C),B=v(B,O),x=v(x,O),z=Math.round(z),T=Math.round(T),w=Math.round(w),E=Math.round(E),it?i(y,z,T,w,E,at,!ot&&!x,!ot&&!Dt,!C&&!Dt,!C&&!x):o(y,z,T,w,E,at,ot&&x&&mt,ot&&Dt&&M,C&&Dt&&I,C&&x&&B)}return s(p,d),p.fill(),l}var n={minVersion:1,maxVersion:40,ecLevel:"L",left:0,top:0,size:200,fill:"#000",background:null,text:"no text",radius:.5,quiet:0};xr=function(l,d){var p={};Object.assign(p,n,l),p.N=p.minVersion,p.K=p.maxVersion,p.v=p.ecLevel,p.left=p.left,p.top=p.top,p.size=p.size,p.fill=p.fill,p.background=p.background,p.text=p.text,p.R=p.radius,p.P=p.quiet,d instanceof HTMLCanvasElement?((d.width!==p.size||d.height!==p.size)&&(d.width=p.size,d.height=p.size),d.getContext("2d").clearRect(0,0,d.width,d.height),r(d,p)):(l=document.createElement("canvas"),l.width=p.size,l.height=p.size,p=r(l,p),d.appendChild(p))}})(function(){function e(d){var p=i.s(d);return{S:function(){return 4},b:function(){return p.length},write:function(g){for(var u=0;u<p.length;u+=1)g.put(p[u],8)}}}function t(){var d=[],p=0,g={B:function(){return d},c:function(u){return(d[Math.floor(u/8)]>>>7-u%8&1)==1},put:function(u,f){for(var m=0;m<f;m+=1)g.m((u>>>f-m-1&1)==1)},f:function(){return p},m:function(u){var f=Math.floor(p/8);d.length<=f&&d.push(0),u&&(d[f]|=128>>>p%8),p+=1}};return g}function i(d,p){function g(x,C){for(var v=-1;7>=v;v+=1)if(!(-1>=x+v||b<=x+v))for(var w=-1;7>=w;w+=1)-1>=C+w||b<=C+w||(m[x+v][C+w]=0<=v&&6>=v&&(w==0||w==6)||0<=w&&6>=w&&(v==0||v==6)||2<=v&&4>=v&&2<=w&&4>=w)}function u(x,C){for(var v=b=4*d+17,w=Array(v),E=0;E<v;E+=1){w[E]=Array(v);for(var M=0;M<v;M+=1)w[E][M]=null}for(m=w,g(0,0),g(b-7,0),g(0,b-7),v=r.G(d),w=0;w<v.length;w+=1)for(E=0;E<v.length;E+=1){M=v[w];var B=v[E];if(m[M][B]==null)for(var O=-2;2>=O;O+=1)for(var I=-2;2>=I;I+=1)m[M+O][B+I]=O==-2||O==2||I==-2||I==2||O==0&&I==0}for(v=8;v<b-8;v+=1)m[v][6]==null&&(m[v][6]=v%2==0);for(v=8;v<b-8;v+=1)m[6][v]==null&&(m[6][v]=v%2==0);for(v=r.w(f<<3|C),w=0;15>w;w+=1)E=!x&&(v>>w&1)==1,m[6>w?w:8>w?w+1:b-15+w][8]=E,m[8][8>w?b-w-1:9>w?15-w:14-w]=E;if(m[b-8][8]=!x,7<=d){for(v=r.A(d),w=0;18>w;w+=1)E=!x&&(v>>w&1)==1,m[Math.floor(w/3)][w%3+b-8-3]=E;for(w=0;18>w;w+=1)E=!x&&(v>>w&1)==1,m[w%3+b-8-3][Math.floor(w/3)]=E}if(y==null){for(x=l.I(d,f),v=t(),w=0;w<z.length;w+=1)E=z[w],v.put(4,4),v.put(E.b(),r.f(4,d)),E.write(v);for(w=E=0;w<x.length;w+=1)E+=x[w].j;if(v.f()>8*E)throw Error("code length overflow. ("+v.f()+">"+8*E+")");for(v.f()+4<=8*E&&v.put(0,4);v.f()%8!=0;)v.m(!1);for(;!(v.f()>=8*E)&&(v.put(236,8),!(v.f()>=8*E));)v.put(17,8);var at=0;for(E=w=0,M=Array(x.length),B=Array(x.length),O=0;O<x.length;O+=1){var it=x[O].j,mt=x[O].o-it;for(w=Math.max(w,it),E=Math.max(E,mt),M[O]=Array(it),I=0;I<M[O].length;I+=1)M[O][I]=255&v.B()[I+at];for(at+=it,I=r.C(mt),it=o(M[O],I.b()-1).l(I),B[O]=Array(I.b()-1),I=0;I<B[O].length;I+=1)mt=I+it.b()-B[O].length,B[O][I]=0<=mt?it.c(mt):0}for(I=v=0;I<x.length;I+=1)v+=x[I].o;for(v=Array(v),I=at=0;I<w;I+=1)for(O=0;O<x.length;O+=1)I<M[O].length&&(v[at]=M[O][I],at+=1);for(I=0;I<E;I+=1)for(O=0;O<x.length;O+=1)I<B[O].length&&(v[at]=B[O][I],at+=1);y=v}for(x=y,v=-1,w=b-1,E=7,M=0,C=r.F(C),B=b-1;0<B;B-=2)for(B==6&&--B;;){for(O=0;2>O;O+=1)m[w][B-O]==null&&(I=!1,M<x.length&&(I=(x[M]>>>E&1)==1),C(w,B-O)&&(I=!I),m[w][B-O]=I,--E,E==-1&&(M+=1,E=7));if(w+=v,0>w||b<=w){w-=v,v=-v;break}}}var f=s[p],m=null,b=0,y=null,z=[],T={u:function(x){x=e(x),z.push(x),y=null},a:function(x,C){if(0>x||b<=x||0>C||b<=C)throw Error(x+","+C);return m[x][C]},h:function(){return b},J:function(){for(var x=0,C=0,v=0;8>v;v+=1){u(!0,v);var w=r.D(T);(v==0||x>w)&&(x=w,C=v)}u(!1,C)}};return T}function o(d,p){if(typeof d.length>"u")throw Error(d.length+"/"+p);var g=function(){for(var f=0;f<d.length&&d[f]==0;)f+=1;for(var m=Array(d.length-f+p),b=0;b<d.length-f;b+=1)m[b]=d[b+f];return m}(),u={c:function(f){return g[f]},b:function(){return g.length},multiply:function(f){for(var m=Array(u.b()+f.b()-1),b=0;b<u.b();b+=1)for(var y=0;y<f.b();y+=1)m[b+y]^=n.i(n.g(u.c(b))+n.g(f.c(y)));return o(m,0)},l:function(f){if(0>u.b()-f.b())return u;for(var m=n.g(u.c(0))-n.g(f.c(0)),b=Array(u.b()),y=0;y<u.b();y+=1)b[y]=u.c(y);for(y=0;y<f.b();y+=1)b[y]^=n.i(n.g(f.c(y))+m);return o(b,0).l(f)}};return u}i.s=function(d){for(var p=[],g=0;g<d.length;g++){var u=d.charCodeAt(g);128>u?p.push(u):2048>u?p.push(192|u>>6,128|u&63):55296>u||57344<=u?p.push(224|u>>12,128|u>>6&63,128|u&63):(g++,u=65536+((u&1023)<<10|d.charCodeAt(g)&1023),p.push(240|u>>18,128|u>>12&63,128|u>>6&63,128|u&63))}return p};var s={L:1,M:0,Q:3,H:2},r=function(){function d(u){for(var f=0;u!=0;)f+=1,u>>>=1;return f}var p=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],g={w:function(u){for(var f=u<<10;0<=d(f)-d(1335);)f^=1335<<d(f)-d(1335);return(u<<10|f)^21522},A:function(u){for(var f=u<<12;0<=d(f)-d(7973);)f^=7973<<d(f)-d(7973);return u<<12|f},G:function(u){return p[u-1]},F:function(u){switch(u){case 0:return function(f,m){return(f+m)%2==0};case 1:return function(f){return f%2==0};case 2:return function(f,m){return m%3==0};case 3:return function(f,m){return(f+m)%3==0};case 4:return function(f,m){return(Math.floor(f/2)+Math.floor(m/3))%2==0};case 5:return function(f,m){return f*m%2+f*m%3==0};case 6:return function(f,m){return(f*m%2+f*m%3)%2==0};case 7:return function(f,m){return(f*m%3+(f+m)%2)%2==0};default:throw Error("bad maskPattern:"+u)}},C:function(u){for(var f=o([1],0),m=0;m<u;m+=1)f=f.multiply(o([1,n.i(m)],0));return f},f:function(u,f){if(u!=4||1>f||40<f)throw Error("mode: "+u+"; type: "+f);return 10>f?8:16},D:function(u){for(var f=u.h(),m=0,b=0;b<f;b+=1)for(var y=0;y<f;y+=1){for(var z=0,T=u.a(b,y),x=-1;1>=x;x+=1)if(!(0>b+x||f<=b+x))for(var C=-1;1>=C;C+=1)0>y+C||f<=y+C||(x!=0||C!=0)&&T==u.a(b+x,y+C)&&(z+=1);5<z&&(m+=3+z-5)}for(b=0;b<f-1;b+=1)for(y=0;y<f-1;y+=1)z=0,u.a(b,y)&&(z+=1),u.a(b+1,y)&&(z+=1),u.a(b,y+1)&&(z+=1),u.a(b+1,y+1)&&(z+=1),(z==0||z==4)&&(m+=3);for(b=0;b<f;b+=1)for(y=0;y<f-6;y+=1)u.a(b,y)&&!u.a(b,y+1)&&u.a(b,y+2)&&u.a(b,y+3)&&u.a(b,y+4)&&!u.a(b,y+5)&&u.a(b,y+6)&&(m+=40);for(y=0;y<f;y+=1)for(b=0;b<f-6;b+=1)u.a(b,y)&&!u.a(b+1,y)&&u.a(b+2,y)&&u.a(b+3,y)&&u.a(b+4,y)&&!u.a(b+5,y)&&u.a(b+6,y)&&(m+=40);for(y=z=0;y<f;y+=1)for(b=0;b<f;b+=1)u.a(b,y)&&(z+=1);return m+=Math.abs(100*z/f/f-50)/5*10}};return g}(),n=function(){for(var d=Array(256),p=Array(256),g=0;8>g;g+=1)d[g]=1<<g;for(g=8;256>g;g+=1)d[g]=d[g-4]^d[g-5]^d[g-6]^d[g-8];for(g=0;255>g;g+=1)p[d[g]]=g;return{g:function(u){if(1>u)throw Error("glog("+u+")");return p[u]},i:function(u){for(;0>u;)u+=255;for(;256<=u;)u-=255;return d[u]}}}(),l=function(){function d(u,f){switch(f){case s.L:return p[4*(u-1)];case s.M:return p[4*(u-1)+1];case s.Q:return p[4*(u-1)+2];case s.H:return p[4*(u-1)+3]}}var p=[[1,26,19],[1,26,16],[1,26,13],[1,26,9],[1,44,34],[1,44,28],[1,44,22],[1,44,16],[1,70,55],[1,70,44],[2,35,17],[2,35,13],[1,100,80],[2,50,32],[2,50,24],[4,25,9],[1,134,108],[2,67,43],[2,33,15,2,34,16],[2,33,11,2,34,12],[2,86,68],[4,43,27],[4,43,19],[4,43,15],[2,98,78],[4,49,31],[2,32,14,4,33,15],[4,39,13,1,40,14],[2,121,97],[2,60,38,2,61,39],[4,40,18,2,41,19],[4,40,14,2,41,15],[2,146,116],[3,58,36,2,59,37],[4,36,16,4,37,17],[4,36,12,4,37,13],[2,86,68,2,87,69],[4,69,43,1,70,44],[6,43,19,2,44,20],[6,43,15,2,44,16],[4,101,81],[1,80,50,4,81,51],[4,50,22,4,51,23],[3,36,12,8,37,13],[2,116,92,2,117,93],[6,58,36,2,59,37],[4,46,20,6,47,21],[7,42,14,4,43,15],[4,133,107],[8,59,37,1,60,38],[8,44,20,4,45,21],[12,33,11,4,34,12],[3,145,115,1,146,116],[4,64,40,5,65,41],[11,36,16,5,37,17],[11,36,12,5,37,13],[5,109,87,1,110,88],[5,65,41,5,66,42],[5,54,24,7,55,25],[11,36,12,7,37,13],[5,122,98,1,123,99],[7,73,45,3,74,46],[15,43,19,2,44,20],[3,45,15,13,46,16],[1,135,107,5,136,108],[10,74,46,1,75,47],[1,50,22,15,51,23],[2,42,14,17,43,15],[5,150,120,1,151,121],[9,69,43,4,70,44],[17,50,22,1,51,23],[2,42,14,19,43,15],[3,141,113,4,142,114],[3,70,44,11,71,45],[17,47,21,4,48,22],[9,39,13,16,40,14],[3,135,107,5,136,108],[3,67,41,13,68,42],[15,54,24,5,55,25],[15,43,15,10,44,16],[4,144,116,4,145,117],[17,68,42],[17,50,22,6,51,23],[19,46,16,6,47,17],[2,139,111,7,140,112],[17,74,46],[7,54,24,16,55,25],[34,37,13],[4,151,121,5,152,122],[4,75,47,14,76,48],[11,54,24,14,55,25],[16,45,15,14,46,16],[6,147,117,4,148,118],[6,73,45,14,74,46],[11,54,24,16,55,25],[30,46,16,2,47,17],[8,132,106,4,133,107],[8,75,47,13,76,48],[7,54,24,22,55,25],[22,45,15,13,46,16],[10,142,114,2,143,115],[19,74,46,4,75,47],[28,50,22,6,51,23],[33,46,16,4,47,17],[8,152,122,4,153,123],[22,73,45,3,74,46],[8,53,23,26,54,24],[12,45,15,28,46,16],[3,147,117,10,148,118],[3,73,45,23,74,46],[4,54,24,31,55,25],[11,45,15,31,46,16],[7,146,116,7,147,117],[21,73,45,7,74,46],[1,53,23,37,54,24],[19,45,15,26,46,16],[5,145,115,10,146,116],[19,75,47,10,76,48],[15,54,24,25,55,25],[23,45,15,25,46,16],[13,145,115,3,146,116],[2,74,46,29,75,47],[42,54,24,1,55,25],[23,45,15,28,46,16],[17,145,115],[10,74,46,23,75,47],[10,54,24,35,55,25],[19,45,15,35,46,16],[17,145,115,1,146,116],[14,74,46,21,75,47],[29,54,24,19,55,25],[11,45,15,46,46,16],[13,145,115,6,146,116],[14,74,46,23,75,47],[44,54,24,7,55,25],[59,46,16,1,47,17],[12,151,121,7,152,122],[12,75,47,26,76,48],[39,54,24,14,55,25],[22,45,15,41,46,16],[6,151,121,14,152,122],[6,75,47,34,76,48],[46,54,24,10,55,25],[2,45,15,64,46,16],[17,152,122,4,153,123],[29,74,46,14,75,47],[49,54,24,10,55,25],[24,45,15,46,46,16],[4,152,122,18,153,123],[13,74,46,32,75,47],[48,54,24,14,55,25],[42,45,15,32,46,16],[20,147,117,4,148,118],[40,75,47,7,76,48],[43,54,24,22,55,25],[10,45,15,67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,16]],g={I:function(u,f){var m=d(u,f);if(typeof m>"u")throw Error("bad rs block @ typeNumber:"+u+"/errorCorrectLevel:"+f);u=m.length/3,f=[];for(var b=0;b<u;b+=1)for(var y=m[3*b],z=m[3*b+1],T=m[3*b+2],x=0;x<y;x+=1){var C=T,v={};v.o=z,v.j=C,f.push(v)}return f}};return g}();return i}());const pl=QrCreator;var Ht=class extends A{constructor(){super(...arguments),this.value="",this.label="",this.size=128,this.fill="black",this.background="white",this.radius=0,this.errorCorrection="H"}firstUpdated(){this.generate()}generate(){this.hasUpdated&&pl.render({text:this.value,radius:this.radius,ecLevel:this.errorCorrection,fill:this.fill,background:this.background,size:this.size*2},this.canvas)}render(){var e;return h`
      ...
      ></canvas>
    `}};Ht.styles=[P,hl];a([$("canvas")],Ht.prototype,"canvas",2);a([c()],Ht.prototype,"value",2);a([c()],Ht.prototype,"label",2);a([c({type:Number})],Ht.prototype,"size",2);a([c()],Ht.prototype,"fill",2);a([c()],Ht.prototype,"background",2);a([c({type:Number})],Ht.prototype,"radius",2);a([c({attribute:"error-correction"})],Ht.prototype,"errorCorrection",2);a([_(["background","errorCorrection","fill","radius","size","value"])],Ht.prototype,"generate",1);Ht.define("sl-qr-code");var ul=k`
  :host {
    display: block;
  }
...
`,yi=class extends A{constructor(){super(...arguments),this.localize=new U(this),this.value=0,this.indeterminate=!1,this.label=""}render(){return h`
      <div
        part="base"
    ...
    `}};yi.styles=[P,gl];a([c({type:Number,reflect:!0})],yi.prototype,"value",2);a([c({type:Boolean,reflect:!0})],yi.prototype,"indeterminate",2);a([c()],yi.prototype,"label",2);yi.define("sl-progress-bar");var ml=k`
  :host {
    display: block;
  }
...
`,_r=class extends A{render(){return h` <slot part="base" class="menu-label"></slot> `}};_r.styles=[P,ml];_r.define("sl-menu-label");var bl=k`
  :host {
    display: contents;
  }
`,Zt=class extends A{constructor(){super(...arguments),this.attrOldValue=!1,this.charData=!1,this.charDataOldValue=!1,this.childList=!1,this.disabled=!1,this.handleMutation=e=>{this.emit("sl-mutation",{detail:{mutationList:e}})}}connectedCallback(){super.connectedCallback(),this.mutationObserver=new MutationObserver(this.handleMutation),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}startObserver(){const e=typeof this.attr=="string"&&this.attr.length>0,t=e&&this.attr!=="*"?this.attr.split(" "):void 0;try{this.mutationObserver.observe(this,{subtree:!0,childList:this.childList,attributes:e,attributeFilter:t,attributeOldValue:this.attrOldValue,characterData:this.charData,characterDataOldValue:this.charDataOldValue})}catch{}}stopObserver(){this.mutationObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}handleChange(){this.stopObserver(),this.startObserver()}render(){return h` <slot></slot> `}};Zt.styles=[P,bl];a([c({reflect:!0})],Zt.prototype,"attr",2);a([c({attribute:"attr-old-value",type:Boolean,reflect:!0})],Zt.prototype,"attrOldValue",2);a([c({attribute:"char-data",type:Boolean,reflect:!0})],Zt.prototype,"charData",2);a([c({attribute:"char-data-old-value",type:Boolean,reflect:!0})],Zt.prototype,"charDataOldValue",2);a([c({attribute:"child-list",type:Boolean,reflect:!0})],Zt.prototype,"childList",2);a([c({type:Boolean,reflect:!0})],Zt.prototype,"disabled",2);a([_("disabled")],Zt.prototype,"handleDisabledChange",1);a([_("attr",{waitUntilFirstUpdate:!0}),_("attr-old-value",{waitUntilFirstUpdate:!0}),_("char-data",{waitUntilFirstUpdate:!0}),_("char-data-old-value",{waitUntilFirstUpdate:!0}),_("childList",{waitUntilFirstUpdate:!0})],Zt.prototype,"handleChange",1);Zt.define("sl-mutation-observer");var vl=k`
  :host {
    display: block;
  }
...
`,ts=class extends A{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}handleClick(e){const t=["menuitem","menuitemcheckbox"],i=e.composedPath(),o=i.find(l=>{var d;return t.includes(((d=l==null?void 0:l.getAttribute)==null?void 0:d.call(l,"role"))||"")});if(!o||i.find(l=>{var d;return((d=l==null?void 0:l.getAttribute)==null?void 0:d.call(l,"role"))==="menu"})!==this)return;const n=o;n.type==="checkbox"&&(n.checked=!n.checked),this.emit("sl-select",{detail:{item:n}})}handleKeyDown(e){if(e.key==="Enter"||e.key===" "){const t=this.getCurrentItem();e.preventDefault(),e.stopPropagation(),t==null||t.click()}else if(["ArrowDown","ArrowUp","Home","End"].includes(e.key)){const t=this.getAllItems(),i=this.getCurrentItem();let o=i?t.indexOf(i):0;t.length>0&&(e.preventDefault(),e.stopPropagation(),e.key==="ArrowDown"?o++:e.key==="ArrowUp"?o--:e.key==="Home"?o=0:e.key==="End"&&(o=t.length-1),o<0&&(o=t.length-1),o>t.length-1&&(o=0),this.setCurrentItem(t[o]),t[o].focus())}}handleMouseDown(e){const t=e.target;this.isMenuItem(t)&&this.setCurrentItem(t)}handleSlotChange(){const e=this.getAllItems();e.length>0&&this.setCurrentItem(e[0])}isMenuItem(e){var t;return e.tagName.toLowerCase()==="sl-menu-item"||["menuitem","menuitemcheckbox","menuitemradio"].includes((t=e.getAttribute("role"))!=null?t:"")}getAllItems(){return[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>!(e.inert||!this.isMenuItem(e)))}getCurrentItem(){return this.getAllItems().find(e=>e.getAttribute("tabindex")==="0")}setCurrentItem(e){this.getAllItems().forEach(i=>{i.setAttribute("tabindex",i===e?"0":"-1")})}render(){return h`
      <slot
        ...
        @mousedown=${this.handleMouseDown}
      ></slot>
    `}};ts.styles=[P,yl];a([$("slot")],ts.prototype,"defaultSlot",2);ts.define("sl-menu");var xl=k`
  :host {
    --submenu-offset: -2px;
...
`;function*es(e=document.activeElement){e!=null&&(yield e,"shadowRoot"in e&&e.shadowRoot&&e.shadowRoot.mode!=="closed"&&(yield*da(es(e.shadowRoot.activeElement))))}function $r(){return[...es()].pop()}var Ls=new WeakMap;function Cr(e){let t=Ls.get(e);return t||(t=window.getComputedStyle(e,null),Ls.set(e,t)),t}function Pl(e){if(typeof e.checkVisibility=="function")return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});const t=Cr(e);return t.visibility!=="hidden"&&t.display!=="none"}function Ol(e){const t=Cr(e),{overflowY:i,overflowX:o}=t;return i==="scroll"||o==="scroll"?!0:i!=="auto"||o!=="auto"?!1:e.scrollHeight>e.clientHeight&&i==="auto"||e.scrollWidth>e.clientWidth&&o==="auto"}function Rl(e){const t=e.tagName.toLowerCase(),i=Number(e.getAttribute("tabindex"));if(e.hasAttribute("tabindex")&&(isNaN(i)||i<=-1)||e.hasAttribute("disabled")||e.closest("[inert]"))return!1;if(t==="input"&&e.getAttribute("type")==="radio"){const r=e.getRootNode(),n=`input[type='radio'][name="${e.getAttribute("name")}"]`,l=r.querySelector(`${n}:checked`);return l?l===e:r.querySelector(n)===e}return Pl(e)?(t==="audio"||t==="video")&&e.hasAttribute("controls")||e.hasAttribute("tabindex")||e.hasAttribute("contenteditable")&&e.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(t)?!0:Ol(e):!1}function Ml(e){var t,i;const o=xo(e),s=(t=o[0])!=null?t:null,r=(i=o[o.length-1])!=null?i:null;return{start:s,end:r}}function Fl(e,t){var i;return((i=e.getRootNode({composed:!0}))==null?void 0:i.host)!==t}function xo(e){const t=new WeakMap,i=[];function o(s){if(s instanceof Element){if(s.hasAttribute("inert")||s.closest("[inert]")||t.has(s))return;t.set(s,!0),!i.includes(s)&&Rl(s)&&i.push(s),s instanceof HTMLSlotElement&&Fl(s,e)&&s.assignedElements({flatten:!0}).forEach(r=>{o(r)}),s.shadowRoot!==null&&s.shadowRoot.mode==="open"&&o(s.shadowRoot)}for(const r of s.children)o(r)}return o(e),i.sort((s,r)=>{const n=Number(s.getAttribute("tabindex"))||0;return(Number(r.getAttribute("tabindex"))||0)-n})}var Xe=[],zr=class{constructor(e){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var i;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;const o=$r();if(this.previousFocus=o,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";const s=xo(this.element);let r=s.findIndex(l=>l===o);this.previousFocus=this.currentFocus;const n=this.tabDirection==="forward"?1:-1;for(;;){r+n>=s.length?r=0:r+n<0?r=s.length-1:r+=n,this.previousFocus=this.currentFocus;const l=s[r];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||l&&this.possiblyHasTabbableChildren(l))return;t.preventDefault(),this.currentFocus=l,(i=this.currentFocus)==null||i.focus({preventScroll:!1});const d=[...es()];if(d.includes(this.currentFocus)||!d.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){Xe.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){Xe=Xe.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return Xe[Xe.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){const e=xo(this.element);if(!this.element.matches(":focus-within")){const t=e[0],i=e[e.length-1],o=this.tabDirection==="forward"?t:i;typeof(o==null?void 0:o.focus)=="function"&&(this.currentFocus=o,o.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}},is=e=>{var t;const{activeElement:i}=document;i&&e.contains(i)&&((t=document.activeElement)==null||t.blur())};function Ps(e){return e.charAt(0).toUpperCase()+e.slice(1)}var Tt=class extends A{constructor(){super(...arguments),this.hasSlotController=new xt(this,"footer"),this.localize=new U(this),this.modal=new zr(this),this.open=!1,this.label="",this.placement="end",this.contained=!1,this.noHeader=!1,this.handleDocumentKeyDown=e=>{this.contained||e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopImmediatePropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.drawer.hidden=!this.open,this.open&&(this.addOpenListeners(),this.contained||(this.modal.activate(),ti(this)))}disconnectedCallback(){super.disconnectedCallback(),ei(this),this.removeOpenListeners()}requestClose(e){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){const i=Y(this,"drawer.denyClose",{dir:this.localize.dir()});J(this.panel,i.keyframes,i.options);return}this.hide()}addOpenListeners(){var e;"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.contained||(this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard"))):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var e;document.removeEventListener("keydown",this.handleDocumentKeyDown),(e=this.closeWatcher)==null||e.destroy()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.contained||(this.modal.activate(),ti(this));const e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([rt(this.drawer),rt(this.overlay)]),this.drawer.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});const t=Y(this,`drawer.show${Ps(this.placement)}`,{dir:this.localize.dir()}),i=Y(this,"drawer.overlay.show",{dir:this.localize.dir()});await Promise.all([J(this.panel,t.keyframes,t.options),J(this.overlay,i.keyframes,i.options)]),this.emit("sl-after-show")}else{is(this),this.emit("sl-hide"),this.removeOpenListeners(),this.contained||(this.modal.deactivate(),ei(this)),await Promise.all([rt(this.drawer),rt(this.overlay)]);const e=Y(this,`drawer.hide${Ps(this.placement)}`,{dir:this.localize.dir()}),t=Y(this,"drawer.overlay.hide",{dir:this.localize.dir()});await Promise.all([J(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),J(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.drawer.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1;const i=this.originalTrigger;typeof(i==null?void 0:i.focus)=="function"&&setTimeout(()=>i.focus()),this.emit("sl-after-hide")}}handleNoModalChange(){this.open&&!this.contained&&(this.modal.activate(),ti(this)),this.open&&this.contained&&(this.modal.deactivate(),ei(this))}async show(){if(!this.open)return this.open=!0,yt(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,yt(this,"sl-after-hide")}render(){return h`
      <div
        part="base"
...
`,q=class extends A{constructor(){super(...arguments),this.formControlController=new ie(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new xt(this,"[default]","prefix","suffix"),this.localize=new U(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Bi}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){const e=this.isLink(),t=e?Ri`a`:Ri`button`;return Je`
    ...
    `}};H.styles=[P,Nl];H.dependencies={"sl-button-group":$e,"sl-button":q,"sl-dropdown":gt,"sl-icon":K,"sl-input":F,"sl-visually-hidden":Qo};a([$('[part~="base"]')],H.prototype,"base",2);a([$('[part~="input"]')],H.prototype,"input",2);a([$(".color-dropdown")],H.prototype,"dropdown",2);a([$('[part~="preview"]')],H.prototype,"previewButton",2);a([$('[part~="trigger"]')],H.prototype,"trigger",2);a([D()],H.prototype,"hasFocus",2);a([D()],H.prototype,"isDraggingGridHandle",2);a([D()],H.prototype,"isEmpty",2);a([D()],H.prototype,"inputValue",2);a([D()],H.prototype,"hue",2);a([D()],H.prototype,"saturation",2);a([D()],H.prototype,"brightness",2);a([D()],H.prototype,"alpha",2);a([c()],H.prototype,"value",2);a([Re()],H.prototype,"defaultValue",2);a([c()],H.prototype,"label",2);a([c()],H.prototype,"format",2);a([c({type:Boolean,reflect:!0})],H.prototype,"inline",2);a([c({reflect:!0})],H.prototype,"size",2);a([c({attribute:"no-format-toggle",type:Boolean})],H.prototype,"noFormatToggle",2);a([c()],H.prototype,"name",2);a([c({type:Boolean,reflect:!0})],H.prototype,"disabled",2);a([c({type:Boolean})],H.prototype,"hoist",2);a([c({type:Boolean})],H.prototype,"opacity",2);a([c({type:Boolean})],H.prototype,"uppercase",2);a([c()],H.prototype,"swatches",2);a([c({reflect:!0})],H.prototype,"form",2);a([c({type:Boolean,reflect:!0})],H.prototype,"required",2);a([pi({passive:!1})],H.prototype,"handleTouchMove",1);a([_("format",{waitUntilFirstUpdate:!0})],H.prototype,"handleFormatChange",1);a([_("opacity",{waitUntilFirstUpdate:!0})],H.prototype,"handleOpacityChange",1);a([_("value")],H.prototype,"handleValueChange",1);H.define("sl-color-picker");var oc=k`
  :host {
    --border-color: var(--sl-color-neutral-200);
    --border-radius: var(--sl-border-radius-medium);
    --border-width: 1px;
...
`,Ar=class extends A{constructor(){super(...arguments),this.hasSlotController=new xt(this,"footer","header","image")}render(){return h`
      <div
        part="base"
      ...
      <div part="base" class="carousel">
        ...
        ${this.pagination?h`
              <div part="pagination" role="tablist" class="carousel__pagination">
                ${ac(nc(i),l=>{const d=l===o;return h`
                    <button
...
`,Er=class extends A{connectedCallback(){super.connectedCallback()}render(){return h` <slot></slot> `}};Er.styles=[P,cc];Er.define("sl-carousel-item");var dc=k`
  :host {
    display: inline-flex;
  }
...
`,he=class extends A{constructor(){super(...arguments),this.hasSlotController=new xt(this,"prefix","suffix"),this.renderType="button",this.rel="noreferrer noopener"}setRenderType(){const e=this.defaultSlot.assignedElements({flatten:!0}).filter(t=>t.tagName.toLowerCase()==="sl-dropdown").length>0;if(this.href){this.renderType="link";return}if(e){this.renderType="dropdown";return}this.renderType="button"}hrefChanged(){this.setRenderType()}handleSlotChange(){this.setRenderType()}render(){return h`
    ...
    `}};he.styles=[P,dc];a([$("slot:not([name])")],he.prototype,"defaultSlot",2);a([D()],he.prototype,"renderType",2);a([c()],he.prototype,"href",2);a([c()],he.prototype,"target",2);a([c()],he.prototype,"rel",2);a([_("href",{waitUntilFirstUpdate:!0})],he.prototype,"hrefChanged",1);he.define("sl-breadcrumb-item");$e.define("sl-button-group");var hc=k`
  :host {
    display: inline-block;
...
`,Jt=class extends A{constructor(){super(...arguments),this.hasError=!1,this.image="",this.label="",this.initials="",this.loading="eager",this.shape="circle"}handleImageChange(){this.hasError=!1}handleImageLoadError(){this.hasError=!0,this.emit("sl-error")}render(){const e=h`
    ...
    `}};Jt.styles=[P,hc];Jt.dependencies={"sl-icon":K};a([D()],Jt.prototype,"hasError",2);a([c()],Jt.prototype,"image",2);a([c()],Jt.prototype,"label",2);a([c()],Jt.prototype,"initials",2);a([c()],Jt.prototype,"loading",2);a([c({reflect:!0})],Jt.prototype,"shape",2);a([_("image")],Jt.prototype,"handleImageChange",1);Jt.define("sl-avatar");var pc=k`
  .breadcrumb {
    display: flex;
    align-items: center;
    flex-wrap: wrap;
...
`,Ue=class extends A{constructor(){super(...arguments),this.localize=new U(this),this.separatorDir=this.localize.dir(),this.label=""}getSeparator(){const t=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[t,...t.querySelectorAll("[id]")].forEach(i=>i.removeAttribute("id")),t.setAttribute("data-default",""),t.slot="separator",t}handleSlotChange(){const e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(t=>t.tagName.toLowerCase()==="sl-breadcrumb-item");e.forEach((t,i)=>{const o=t.querySelector('[slot="separator"]');o===null?t.append(this.getSeparator()):o.hasAttribute("data-default")&&o.replaceWith(this.getSeparator()),i===e.length-1?t.setAttribute("aria-current","page"):t.removeAttribute("aria-current")})}render(){return this.separatorDir!==this.localize.dir()&&(this.separatorDir=this.localize.dir(),this.updateComplete.then(()=>this.handleSlotChange())),h`
    ...
    `}};Ue.styles=[P,pc];Ue.dependencies={"sl-icon":K};a([$("slot")],Ue.prototype,"defaultSlot",2);a([$('slot[name="separator"]')],Ue.prototype,"separatorSlot",2);a([c()],Ue.prototype,"label",2);Ue.define("sl-breadcrumb");q.define("sl-button");var uc=k`
  :host {
...
`,xi=class extends A{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return h`
      <span
        part="base"
    ...
    `}};xi.styles=[P,fc];a([c({reflect:!0})],xi.prototype,"variant",2);a([c({type:Boolean,reflect:!0})],xi.prototype,"pill",2);a([c({type:Boolean,reflect:!0})],xi.prototype,"pulse",2);xi.define("sl-badge");var gc=k`
  :host {
    display: contents;
...
`,ht=class extends A{constructor(){super(...arguments),this.hasStarted=!1,this.name="none",this.play=!1,this.delay=0,this.direction="normal",this.duration=1e3,this.easing="linear",this.endDelay=0,this.fill="auto",this.iterations=1/0,this.iterationStart=0,this.playbackRate=1,this.handleAnimationFinish=()=>{this.play=!1,this.hasStarted=!1,this.emit("sl-finish")},this.handleAnimationCancel=()=>{this.play=!1,this.hasStarted=!1,this.emit("sl-cancel")}}get currentTime(){var e,t;return(t=(e=this.animation)==null?void 0:e.currentTime)!=null?t:0}set currentTime(e){this.animation&&(this.animation.currentTime=e)}connectedCallback(){super.connectedCallback(),this.createAnimation()}disconnectedCallback(){super.disconnectedCallback(),this.destroyAnimation()}handleSlotChange(){this.destroyAnimation(),this.createAnimation()}async createAnimation(){var e,t;const i=(e=Tr[this.easing])!=null?e:this.easing,o=(t=this.keyframes)!=null?t:nh[this.name],r=(await this.defaultSlot).assignedElements()[0];return!r||!o?!1:(this.destroyAnimation(),this.animation=r.animate(o,{delay:this.delay,direction:this.direction,duration:this.duration,easing:i,endDelay:this.endDelay,fill:this.fill,iterationStart:this.iterationStart,iterations:this.iterations}),this.animation.playbackRate=this.playbackRate,this.animation.addEventListener("cancel",this.handleAnimationCancel),this.animation.addEventListener("finish",this.handleAnimationFinish),this.play?(this.hasStarted=!0,this.emit("sl-start")):this.animation.pause(),!0)}destroyAnimation(){this.animation&&(this.animation.cancel(),this.animation.removeEventListener("cancel",this.handleAnimationCancel),this.animation.removeEventListener("finish",this.handleAnimationFinish),this.hasStarted=!1)}handleAnimationChange(){this.hasUpdated&&this.createAnimation()}handlePlayChange(){return this.animation?(this.play&&!this.hasStarted&&(this.hasStarted=!0,this.emit("sl-start")),this.play?this.animation.play():this.animation.pause(),!0):!1}handlePlaybackRateChange(){this.animation&&(this.animation.playbackRate=this.playbackRate)}cancel(){var e;(e=this.animation)==null||e.cancel()}finish(){var e;(e=this.animation)==null||e.finish()}render(){return h` <slot @slotchange=${this.handleSlotChange}></slot> `}};ht.styles=[P,lh];a([Sa("slot")],ht.prototype,"defaultSlot",2);a([c()],ht.prototype,"name",2);a([c({type:Boolean,reflect:!0})],ht.prototype,"play",2);a([c({type:Number})],ht.prototype,"delay",2);a([c()],ht.prototype,"direction",2);a([c({type:Number})],ht.prototype,"duration",2);a([c()],ht.prototype,"easing",2);a([c({attribute:"end-delay",type:Number})],ht.prototype,"endDelay",2);a([c()],ht.prototype,"fill",2);a([c({type:Number})],ht.prototype,"iterations",2);a([c({attribute:"iteration-start",type:Number})],ht.prototype,"iterationStart",2);a([c({attribute:!1})],ht.prototype,"keyframes",2);a([c({attribute:"playback-rate",type:Number})],ht.prototype,"playbackRate",2);a([_(["name","delay","direction","duration","easing","endDelay","fill","iterations","iterationsStart","keyframes"])],ht.prototype,"handleAnimationChange",1);a([_("play")],ht.prototype,"handlePlayChange",1);a([_("playbackRate")],ht.prototype,"handlePlaybackRateChange",1);ht.define("sl-animation");class _o extends G{constructor(){super(),this.currentRoute="home",this._searchResults=[],this._searchOpen=!1,this._searchLoading=!1,this._searchTimer=null,this._handleDocClick=this._handleDocClick.bind(this)}_isActive(t){return t==="articles"&&(this.currentRoute==="articles"||this.currentRoute==="article-detail")||this.currentRoute===t?"active":""}firstUpdated(){this._updateIndicator()}updated(t){t.has("currentRoute")&&this._updateIndicator()}_updateIndicator(){requestAnimationFrame(()=>{var d;const t=(d=this.shadowRoot)==null?void 0:d.querySelector(".nav-tabs"),i=t==null?void 0:t.querySelector("a.active"),o=t==null?void 0:t.querySelector(".nav-tabs-indicator");if(!t||!i||!o)return;const s=t.getBoundingClientRect(),r=i.getBoundingClientRect(),n=20,l=20;o.style.left=`${r.left-s.left+n}px`,o.style.width=`${r.width-n-l}px`})}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._handleDocClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleDocClick)}_handleDocClick(t){t.composedPath().includes(this)||(this._searchOpen=!1)}_onSearchInput(t){const i=t.target.value.trim();if(clearTimeout(this._searchTimer),i.length<1){this._searchOpen=!1,this._searchResults=[];return}this._searchLoading=!0,this._searchOpen=!0,this._searchTimer=setTimeout(()=>this._doSearch(i),250)}async _doSearch(t){try{const i=await fetch(`/api/search?q=${encodeURIComponent(t)}`);if(!i.ok){this._searchResults=[];return}const o=await i.json();this._searchResults=o.results||[]}catch{this._searchResults=[]}finally{this._searchLoading=!1}}_onSearchFocus(t){t.target.value.trim()&&this._searchResults.length&&(this._searchOpen=!0)}_onSearchKeydown(t){t.key==="Escape"&&(this._searchOpen=!1,t.target.blur())}_getResultHref(t){return t.is_own_product&&t.custom_url?t.custom_url:t.original_url?t.original_url:t.ms_id?"/detail/"+t.ms_id:"#"}_isResultInternal(t){return!!(t.is_own_product&&t.custom_url)}_onResultClick(t,i){var s;this._searchOpen=!1;const o=this._getResultHref(i);this._isResultInternal(i)&&(t.preventDefault(),(s=window.msApp)==null||s.navigate(o))}render(){return h`
    ...
    `}}R(_o,"properties",{currentRoute:{type:String},_searchResults:{state:!0},_searchOpen:{state:!0},_searchLoading:{state:!0}}),R(_o,"styles",k`
    :host {
      display: block;
      position: sticky;
      top: 0;
  ...
  `);customElements.define("ms-header",_o);class Ir extends G{render(){return h`
      <footer>
  ...
  `);customElements.define("ms-footer",Ir);const Us=new Map;async function ci(e,t=5*60*1e3){const i=Us.get(e);if(i&&Date.now()-i.ts<t)return i.data;const s=await(await fetch(e)).json();return Us.set(e,{data:s,ts:Date.now()}),s}function Ns(e,t){let i=document.querySelector(`meta[name="${e}"]`);t?(i||(i=document.createElement("meta"),i.setAttribute("name",e),document.head.appendChild(i)),i.setAttribute("content",t)):i&&i.remove()}function ze({title:e,keywords:t,description:i}){e&&(document.title=e),Ns("keywords",t||""),Ns("description",i||"")}class ko extends G{constructor(){super(),this.src="",this.alt="",this.width="",this.height="",this.radius="0",this.objectFit="cover",this.eager=!1,this._loaded=!1,this._inView=!1,this._error=!1,this._observer=null}_checkInView(){var o;const t=this.getBoundingClientRect(),i=300;t.top<window.innerHeight+i&&t.bottom>-i&&(this._inView=!0,(o=this._observer)==null||o.disconnect(),this._observer=null)}connectedCallback(){if(super.connectedCallback(),this.eager){this._inView=!0;return}requestAnimationFrame(()=>{this._inView||this._checkInView()}),this._observer=new IntersectionObserver(t=>{var i;t[0].isIntersecting&&(this._inView=!0,(i=this._observer)==null||i.disconnect())},{rootMargin:"200px",threshold:.01}),this._observer.observe(this)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._observer)==null||t.disconnect()}_onLoad(){this._loaded=!0}_onError(){this._error=!0,this._loaded=!0}updated(t){t.has("src")&&(this._loaded=!1,this._error=!1)}render(){const t=`
    ...
    `;return this.style.cssText=t,h`
      ...
      ${this._inView&&this.src?h`
        ...
        />
      `:""}
    `}}R(ko,"properties",{src:{type:String},alt:{type:String},width:{type:String},height:{type:String},radius:{type:String},objectFit:{type:String,attribute:"object-fit"},eager:{type:Boolean},_loaded:{type:Boolean,state:!0},_inView:{type:Boolean,state:!0},_error:{type:Boolean,state:!0}}),R(ko,"styles",k`
    :host {
      display: inline-block;
      position: relative;
      overflow: hidden;
  ...
  `);customElements.define("ms-lazy-img",ko);const js=[{title:"Microsoft 365",subtitle:"管理每日工作的應用程式",button_text:"获取",badge_text:"",gradient:"linear-gradient(135deg, #1a1a4e 0%, #2d2d8a 40%, #4a4ac7 100%)",link_url:"/detail/microsoft-365"},{title:"Xbox Game Pass",subtitle:"新作上市當天即可暢玩",button_text:"获取",badge_text:"Game Pass",gradient:"linear-gradient(135deg, #0b3d0b 0%, #1a5c1a 40%, #2d7a2d 100%)",link_url:"/detail/xbox-game-pass"},{title:"Minecraft: Java & Bedrock Edition",subtitle:"立即遊戲",button_text:"获取",badge_text:"Game Pass Premium",gradient:"linear-gradient(135deg, #3d2b1f 0%, #6b4423 40%, #8b6914 100%)",link_url:"/detail/minecraft"},{title:"精选应用合集",subtitle:"发现最受欢迎的应用和游戏",button_text:"全部显示",badge_text:"",gradient:"linear-gradient(135deg, #1b2838 0%, #2a475e 40%, #3d6b8e 100%)",link_url:"/apps"},{title:"Copilot",subtitle:"你的日常 AI 助手",button_text:"获取",badge_text:"免费",gradient:"linear-gradient(135deg, #2b1055 0%, #4a2c82 40%, #7b5ea7 100%)",link_url:"/detail/copilot"}],Ws=[{title:"Overwatch® 2",subtitle:"立即透過 Xbox Game Pass 購買或玩遊戲",badge_text:"Game Pass",gradient:"linear-gradient(135deg, #1a1a2e, #16213e, #0f3460)",link_url:"#"},{title:"社交網路應用程式",subtitle:"聯繫和學習",gradient:"linear-gradient(135deg, #2d3436, #636e72)",link_url:"/apps"}];class $o extends G{constructor(){super(),this.banners=js,this.sideCards=Ws,this._activeIndex=0,this._autoplayTimer=null,this._pauseTimeout=null}connectedCallback(){super.connectedCallback(),this._startAutoplay()}disconnectedCallback(){super.disconnectedCallback(),this._stopAutoplay(),clearTimeout(this._pauseTimeout)}get _slides(){var t;return(t=this.banners)!=null&&t.length?this.banners:js}get _cards(){var t;return(t=this.sideCards)!=null&&t.length?this.sideCards:Ws}_startAutoplay(){this._stopAutoplay(),this._autoplayTimer=setInterval(()=>this._next(),6e3)}_stopAutoplay(){this._autoplayTimer&&(clearInterval(this._autoplayTimer),this._autoplayTimer=null)}_restartAutoplayDelayed(){this._stopAutoplay(),clearTimeout(this._pauseTimeout),this._pauseTimeout=setTimeout(()=>this._startAutoplay(),1e4)}_next(){this._activeIndex=(this._activeIndex+1)%this._slides.length}_prev(){this._activeIndex=(this._activeIndex-1+this._slides.length)%this._slides.length}_goTo(t){t!==this._activeIndex&&(this._activeIndex=t,this._restartAutoplayDelayed())}_onArrowClick(t){t==="next"?this._next():this._prev(),this._restartAutoplayDelayed()}_onBannerClick(t){t.link_url&&this.dispatchEvent(new CustomEvent("banner-click",{detail:t,bubbles:!0,composed:!0}))}_renderSlide(t,i){const o=i===this._activeIndex,s=t.image_url||t.local_image,r=t.local_image||t.image_url;return h`
    ...
    `}_renderSplitCard(t,i){const o=s=>{const r=s.image_url||s.local_image,n=s.local_image||s.image_url,l=s.link_url||"#";return h`
    ...
    `}}R($o,"properties",{banners:{type:Array},sideCards:{type:Array},_activeIndex:{type:Number,state:!0}}),R($o,"styles",k`
    :host {
      display: block;
      padding: 12px 0 0;
      user-select: none;
  ...
  `);customElements.define("ms-hero-carousel",$o);class Co extends G{constructor(){super(),this.value=0}render(){const t=Math.max(0,Math.min(5,this.value||0)),i=t/5*100;return h`
      <span class="stars">
        <span class="stars-empty">★★★★★</span>
        <span class="stars-filled" style="width: ${i}%">★★★★★</span>
      </span>
      ${t>0?h`<span class="value">${t.toFixed(1)}</span>`:""}
    `}}R(Co,"properties",{value:{type:Number}}),R(Co,"styles",k`
    :host {
      display: inline-flex;
      align-items: center;
      gap: 3px;
  ...
  `);customElements.define("ms-product-social-card",Eo);const Ee=class Ee extends G{constructor(){super(),this.title="",this.viewAllUrl="",this.products=[],this.variant="default",this.sectionType="",this._showLeftArrow=!1,this._showRightArrow=!0,this._pageIndex=0}static get PAGE_SIZE_TWO_COL(){return 6}updated(t){super.updated(t),t.has("variant")&&this.classList.toggle("variant-two-col",this.variant==="twoColGrid"),this.variant==="twoColGrid"&&t.has("products")&&(this._pageIndex=0)}firstUpdated(){this.classList.toggle("variant-two-col",this.variant==="twoColGrid"),this._updateArrows()}_getScrollContainer(){return this.renderRoot.querySelector(".scroll-container")}_updateArrows(){const t=this._getScrollContainer();t&&(this._showLeftArrow=t.scrollLeft>10,this._showRightArrow=t.scrollLeft<t.scrollWidth-t.clientWidth-10)}_scroll(t){if(this.variant==="twoColGrid"){const s=Math.max(1,Math.ceil((this.products||[]).length/Ee.PAGE_SIZE_TWO_COL));t==="left"&&this._pageIndex>0?this._pageIndex=this._pageIndex-1:t==="right"&&this._pageIndex<s-1&&(this._pageIndex=this._pageIndex+1);return}const i=this._getScrollContainer();if(!i)return;const o=i.clientWidth*.75;i.scrollBy({left:t==="left"?-o:o,behavior:"smooth"}),setTimeout(()=>this._updateArrows(),350)}_onScroll(){this._updateArrows()}_renderCard(t){return this.variant==="hero"?h`<ms-product-hero .product=${t}></ms-product-hero>`:this.variant==="tall"?h`<ms-product-tall-card .product=${t}></ms-product-tall-card>`:this.variant==="social"?h`<ms-product-social-card .product=${t}></ms-product-social-card>`:h`<ms-product-card .product=${t}></ms-product-card>`}_renderPriceRow(t){if(!t)return"";if(t.price_type==="free"||t.price==="免费"||t.price==="Free"||t.price==="免费下载")return h`<span class="product-row-price product-row-price-free">免费下载</span>`;if(t.price_type==="owned")return h`<span class="product-row-price" style="color: #0067b8;">已拥有</span>`;if(t.discount_percent&&t.original_price){const i=t.price||t.original_price;return h`
    ...
    `}_renderHeader(t,i,o){const s=t?!i:!this._showLeftArrow,r=t?!o:!this._showRightArrow;return h`
    ...
    `}render(){const t=this.variant==="twoColGrid",i=this.products||[],o=Ee.PAGE_SIZE_TWO_COL,s=t?Math.max(1,Math.ceil(i.length/o)):1,r=t?i.slice(this._pageIndex*o,(this._pageIndex+1)*o):i,n=t&&this._pageIndex>0,l=t&&this._pageIndex<s-1;return t?h`
        <div class="section">
  ...
  `);let To=Ee;customElements.define("ms-collection-row",To);class Io extends G{constructor(){super(),this.title="",this.viewAllUrl="",this.products=[],this._showLeftArrow=!1,this._showRightArrow=!0}firstUpdated(){this._updateArrows();const t=this._getScrollContainer();t&&t.addEventListener("scroll",this._onScrollBound=()=>this._updateArrows())}disconnectedCallback(){super.disconnectedCallback();const t=this._getScrollContainer();t&&this._onScrollBound&&t.removeEventListener("scroll",this._onScrollBound)}_getScrollContainer(){var t;return(t=this.renderRoot)==null?void 0:t.querySelector(".scroll-container")}_updateArrows(){const t=this._getScrollContainer();t&&(this._showLeftArrow=t.scrollLeft>10,this._showRightArrow=t.scrollLeft<t.scrollWidth-t.clientWidth-10)}_scroll(t){const i=this._getScrollContainer();if(!i)return;const o=i.clientWidth*.75;i.scrollBy({left:t==="left"?-o:o,behavior:"smooth"}),setTimeout(()=>this._updateArrows(),350)}_onScroll(){this._updateArrows()}_renderStars(t=0){const i=Math.floor(t),o=[];for(let s=0;s<5;s++)o.push(h`<span class="star ${s<i?"":"empty"}">★</span>`);return o}_renderPrice(t){if(t.price_type==="free"||t.price===0||t.price==="0"||t.price==="Free")return h`<span class="price-free">免费下载</span>`;const i=[];return t.discount&&t.original_price?(i.push(h`<span class="price-original">${t.original_price}</span>`),i.push(h`<span class="price-current">${t.price}</span>`)):t.price&&i.push(h`<span class="price-current">${t.price}</span>`),i}_renderBadges(t){const i=[];return t.has_gamepass&&i.push(h`<span class="badge badge-gamepass">Game Pass</span>`),t.discount&&i.push(h`<span class="badge badge-discount">-${t.discount}%</span>`),i}_onItemClick(t,i){var o;i.preventDefault(),t.product_id&&((o=window.msApp)==null||o.navigate("/detail/"+t.product_id))}render(){const t=(this.products||[]).slice(0,12);return h`
    ...
    `}}R(Io,"properties",{title:{type:String},viewAllUrl:{type:String},products:{type:Array},_showLeftArrow:{type:Boolean,state:!0},_showRightArrow:{type:Boolean,state:!0}}),R(Io,"styles",k`
    :host {
      display: block;
      box-sizing: border-box;
    }
  ...
  `);customElements.define("ms-collection-grid",Io);class Do extends G{constructor(){super(),this.title="Collections",this.viewAllUrl="",this.cards=[],this._showLeftArrow=!1,this._showRightArrow=!0}firstUpdated(){this._updateArrows()}_getScrollContainer(){return this.renderRoot.querySelector(".scroll-container")}_updateArrows(){const t=this._getScrollContainer();t&&(this._showLeftArrow=t.scrollLeft>10,this._showRightArrow=t.scrollLeft<t.scrollWidth-t.clientWidth-10)}_scroll(t){const i=this._getScrollContainer();if(!i)return;const o=i.clientWidth*.75;i.scrollBy({left:t==="left"?-o:o,behavior:"smooth"}),setTimeout(()=>this._updateArrows(),350)}_onScroll(){this._updateArrows()}_getGradientClass(t){return`card-gradient-${t%6}`}render(){return h`
      <div class="section">
        <div class="section-header">
          <h2 class="section-title">${this.title}</h2>
        </div>
  ...
  `);customElements.define("ms-collection-cards",Do);class Lo extends G{constructor(){super(),this.data=null,this.loading=!0}connectedCallback(){super.connectedCallback(),this._loadData()}async _loadData(){if(this.data){this.loading=!1,this._applySeo();return}try{this.data=await ci("/api/home")}catch(t){console.error("Failed to load home data:",t)}this.loading=!1,this._applySeo()}_applySeo(){var i;if(!((i=this.data)!=null&&i.seo))return;const t=this.data.seo;ze({title:t.title,keywords:t.keywords,description:t.description})}_prepareProducts(t){return(t.products||[]).map(i=>({...i,icon_url:i.local_icon||i.icon_url||"",product_id:i.ms_id||i.id}))}_isTallGameSection(t){const i=(t.name||"").trim(),o=(t.slug||"").toLowerCase();return i==="最畅销的游戏"||i==="全新值得注目的電腦遊戲"||o==="top-grossing"||o==="new-pc-games"||o.includes("topgrossing")||o.includes("new-pc")}_renderCollection(t){const i=this._prepareProducts(t);if(t.section_type==="grid"&&this._isTallGameSection(t))return h`
        <ms-collection-row
          .title=${t.name}
  ...
  `);customElements.define("home-page",Lo);class Po extends G{constructor(){super(),this.banners=[]}render(){return h`
      <div class="section">
    ...
    `}}R(Po,"properties",{banners:{type:Array}}),R(Po,"styles",k`
    :host {
      display: block;
      max-width: var(--ms-content-max-width, 1600px);
      margin: 0 auto;
  ...
  `);customElements.define("ms-featured-row",Po);const Te=class Te extends G{constructor(){super(),this.data=null,this.homeData=null,this.loading=!0}connectedCallback(){super.connectedCallback(),this._loadData()}async _loadData(){if(this.data){this.loading=!1,this._applySeo();return}try{const[t,i]=await Promise.all([ci("/api/apps"),ci("/api/home")]);this.data=t,this.homeData=i}catch(t){console.error("Failed to load apps data:",t)}this.loading=!1,this._applySeo()}_applySeo(){var i;if(!((i=this.data)!=null&&i.seo))return;const t=this.data.seo;ze({title:t.title,keywords:t.keywords,description:t.description})}_prepareProducts(t){return(t.products||[]).map(i=>({...i,icon_url:i.local_icon||i.icon_url||"",product_id:i.ms_id||i.id}))}_isAppPackBanner(t){const i=(t.title||"").trim(),o=(t.subtitle||"").trim();return/多应用|安装介绍|一次选择并安装/.test(i+o)}_buildHeroSideCards(t){if(!(t!=null&&t.length))return[];const i=t.filter(s=>!this._isAppPackBanner(s)),o=i.length>=2?i:t;return o.length>=3?[o[0],{type:"split",left:o[1],right:o[2]}]:o.slice(0,2)}_getAppCollections(){var s,r;const t=[...((s=this.data)==null?void 0:s.collections)||[],...((r=this.homeData)==null?void 0:r.collections)||[]],i=new Set,o=[];for(const n of t){if(i.has(n.id)||(i.add(n.id),n.section_type==="collection_cards"))continue;const l=(n.products||[]).filter(d=>d.product_type==="app");l.length>0&&o.push({...n,products:l})}return o.sort((n,l)=>(n.display_order||0)-(l.display_order||0))}_getCollectionCards(){var s,r;const t=[...((s=this.data)==null?void 0:s.collections)||[],...((r=this.homeData)==null?void 0:r.collections)||[]],i=new Set(["creative-apps-collection","social-networking-collection","best-entertainment-apps","get-started","productivity-apps-collection","personalization-apps","widgets"]),o=t.filter(n=>n.section_type==="collection_cards"&&n.slug!=="collections"&&i.has(n.slug)).sort((n,l)=>(n.display_order||0)-(l.display_order||0)).map(n=>({name:n.name,subtitle:"",link_url:n.view_all_url||"#",image_url:n.hero_image||""}));return o.length===0?t.filter(n=>n.section_type==="collection_cards"&&n.slug!=="collections"&&n.display_order>10).sort((n,l)=>(n.display_order||0)-(l.display_order||0)).map(n=>({name:n.name,subtitle:"",link_url:n.view_all_url||"#",image_url:n.hero_image||""})):o}_isSocialSection(t){const i=(t.name||"").trim(),o=(t.slug||"").toLowerCase();return i==="社交網路應用程式"||o.includes("social")}_renderCollection(t){const i=this._prepareProducts(t);return t.section_type==="grid"?h`
    ...
    `}_renderTopFreeSection(t){const i=this._prepareProducts(t).slice(0,4),o=t.view_all_url||"#",s=Te._apppackIcons;return h`
    ...
    `}render(){var d,p,g,u;if(this.loading)return h`<div class="loading"><div class="loading-spinner"></div><br>正在加载...</div>`;const t=((d=this.data)==null?void 0:d.heroBanners)||((p=this.homeData)==null?void 0:p.heroBanners)||[],i=((g=this.data)==null?void 0:g.featuredBanners)||((u=this.homeData)==null?void 0:u.featuredBanners)||[],o=this._buildHeroSideCards(i),s=this._getAppCollections(),r=this._getCollectionCards(),n=s[0]||null,l=n?s.slice(1):s;return h`
      ${t.length>0?h`
        <ms-hero-carousel .banners=${t} .sideCards=${o}></ms-hero-carousel>
      `:""}
  ...
  `),R(Te,"_apppackIcons",["/assets/images/apppack/sketchbook.png","/assets/images/apppack/acrobat.png","/assets/images/apppack/hulu.png","/assets/images/apppack/clipchamp.png","/assets/images/apppack/whatsapp.png","/assets/images/apppack/concepts.png","/assets/images/apppack/ibispaint.png"]);let Oo=Te;customElements.define("apps-page",Oo);const Ie=class Ie extends G{constructor(){super(),this.data=null,this.homeData=null,this.loading=!0}connectedCallback(){super.connectedCallback(),this._loadData()}async _loadData(){if(this.data){this.loading=!1,this._applySeo();return}try{const[t,i]=await Promise.all([ci("/api/games"),ci("/api/home")]);this.data=t,this.homeData=i}catch(t){console.error("Failed to load games data:",t)}this.loading=!1,this._applySeo()}_applySeo(){var i;if(!((i=this.data)!=null&&i.seo))return;const t=this.data.seo;ze({title:t.title,keywords:t.keywords,description:t.description})}_prepareProducts(t){return(t.products||[]).map(i=>({...i,icon_url:i.local_icon||i.icon_url||"",product_id:i.ms_id||i.id}))}_buildHeroSideCards(t){return t!=null&&t.length?t.length>=3?[t[0],{type:"split",left:t[1],right:t[2]}]:t.slice(0,2):[]}_getGameCollections(){var s,r;const t=[...((s=this.data)==null?void 0:s.collections)||[],...((r=this.homeData)==null?void 0:r.collections)||[]],i=new Set,o=[];for(const n of t){if(i.has(n.id)||(i.add(n.id),n.section_type==="collection_cards"))continue;const l=(n.products||[]).filter(d=>d.product_type==="game");l.length>0&&o.push({...n,products:l})}return o.sort((n,l)=>(n.display_order||0)-(l.display_order||0))}_getCollectionCards(){var s,r;const t=[...((s=this.data)==null?void 0:s.collections)||[],...((r=this.homeData)==null?void 0:r.collections)||[]],i=new Set(["xbox-play-anywhere","racing-games","kids-games","free-games"]),o=t.filter(n=>n.section_type==="collection_cards"&&n.slug!=="collections"&&i.has(n.slug)).sort((n,l)=>(n.display_order||0)-(l.display_order||0)).map(n=>({name:n.name,subtitle:"",link_url:n.view_all_url||"#",image_url:n.hero_image||""}));return o.length===0?t.filter(n=>n.section_type==="collection_cards"&&n.slug!=="collections"&&n.display_order>10).sort((n,l)=>(n.display_order||0)-(l.display_order||0)).map(n=>({name:n.name,subtitle:"",link_url:n.view_all_url||"#",image_url:n.hero_image||""})):o}_isTallGameSection(t){const i=(t.name||"").trim(),o=(t.slug||"").toLowerCase();return i==="最畅销的游戏"||i==="全新值得注目的電腦遊戲"||o==="top-grossing"||o==="new-pc-games"||o.includes("topgrossing")||o.includes("top-grossing")||o.includes("new-notable")||o.includes("new-pc")}_renderCollection(t){const i=this._prepareProducts(t);return t.section_type==="grid"&&this._isTallGameSection(t)?h`
    ...
    `}_renderTopGamesSection(t){const i=this._prepareProducts(t).slice(0,4),o=t.view_all_url||"#",s=Ie._gamepackIcons;return h`
    ...
    `}render(){var d,p,g,u;if(this.loading)return h`<div class="loading"><div class="loading-spinner"></div><br>正在加载...</div>`;const t=((d=this.data)==null?void 0:d.heroBanners)||((p=this.homeData)==null?void 0:p.heroBanners)||[],i=((g=this.data)==null?void 0:g.featuredBanners)||((u=this.homeData)==null?void 0:u.featuredBanners)||[],o=this._buildHeroSideCards(i),s=this._getGameCollections(),r=this._getCollectionCards(),n=s[0]||null,l=n?s.slice(1):s;return h`
      ${t.length>0?h`
        <ms-hero-carousel .banners=${t} .sideCards=${o}></ms-hero-carousel>
        <div class="section-spacer"></div>
      `:""}
  ...
  `);customElements.define("about-page",Dr);class Mo extends G{constructor(){super(),this.productId="",this.customUrl="",this.data=null,this.relatedProducts=[],this.loading=!0,this.descriptionExpanded=!1,this.reviewData=null,this.reviewsExpanded=!1}connectedCallback(){super.connectedCallback(),this._loadData()}updated(t){(t.has("productId")&&this.productId||t.has("customUrl")&&this.customUrl)&&this._loadData()}_scrollScreenshots(t){const i=this.shadowRoot.querySelector(".screenshots-row");if(!i)return;i.scrollBy({left:t*320,behavior:"smooth"})}_toggleDescription(){this.descriptionExpanded=!this.descriptionExpanded}_onScreenshotsScroll(){const t=this.shadowRoot.querySelector(".screenshots-row");if(!t)return;const i=this.shadowRoot.querySelector(".screenshots-nav.prev"),o=this.shadowRoot.querySelector(".screenshots-nav.next");if(i&&i.classList.toggle("hidden",t.scrollLeft<=0),o){const s=t.scrollWidth-t.clientWidth;o.classList.toggle("hidden",t.scrollLeft>=s-5)}}firstUpdated(){super.firstUpdated&&super.firstUpdated(),setTimeout(()=>this._onScreenshotsScroll(),100)}async _loadData(){if(!this.productId&&!this.customUrl){this.loading=!1;return}this.loading=!0;try{let t;this.customUrl?t=`/api/product-by-url?url=${encodeURIComponent(this.customUrl)}`:t=`/api/product/${this.productId}`;const i=await fetch(t);if(i.ok){const o=await i.json();this.data=o,o.id&&(this._loadRelatedProducts(o.id),this._loadReviews(o.id))}else this.data=null}catch(t){console.error("Failed to load product:",t),this.data=null}this.loading=!1,this.data&&this._updatePageMeta()}_updatePageMeta(){const t=this.data;ze({title:t.custom_title||t.title||"Microsoft Store",keywords:t.custom_keywords||"",description:t.custom_description||t.description||""})}async _loadRelatedProducts(t){try{const i=await fetch(`/api/product/${t}/related`);i.ok&&(this.relatedProducts=await i.json())}catch(i){console.error("Failed to load related products:",i)}}async _loadReviews(t){try{const i=await fetch(`/api/product/${t}/reviews`);i.ok&&(this.reviewData=await i.json())}catch(i){console.error("Failed to load reviews:",i)}}_toggleReviews(){this.reviewsExpanded=!this.reviewsExpanded}_onDownloadClick(t){if(!this.data)return;const o=`/api/product/${this.data.ms_id||this.data.id}/download-click`;navigator.sendBeacon?navigator.sendBeacon(o):fetch(o,{method:"POST",keepalive:!0}).catch(()=>{})}_getDownloadUrl(){return this.data?this.data.custom_download_url?this.data.custom_download_url:this.data.ms_id?`https://get.microsoft.com/installer/download/${this.data.ms_id}?hl=zh-cn&gl=hk`:this.data.original_url?this.data.original_url:`https://apps.microsoft.com/detail/${this.data.ms_id}?hl=zh-CN&gl=HK`:"#"}_getMsStoreUrl(){return this.data?`https://apps.microsoft.com/detail/${this.data.ms_id}?hl=zh-CN&gl=HK`:"#"}_normalizeScreenshotMeta(t,i=""){const o={logoAlt:(i||"").trim(),items:[]};if(!t)return o;let s=t;if(typeof t=="string")try{s=JSON.parse(t||"[]")}catch{s=[]}let r=[];return Array.isArray(s)?r=s:s&&Array.isArray(s.items)&&(r=s.items,typeof s.logo_alt=="string"&&s.logo_alt.trim()&&(o.logoAlt=s.logo_alt.trim())),o.items=r.map(n=>{if(typeof n=="string"){const l=n.trim();return l?{url:l,alt:""}:null}if(n&&typeof n=="object"){const l=String(n.url||"").trim();return l?{url:l,alt:String(n.alt||"").trim()}:null}return null}).filter(Boolean),o}_renderPrice(){const t=this.data;return t?t.price_type==="free"||!t.price?h`<span class="price-free">免费</span>`:t.price_type==="discount"&&t.original_price?h`
      ...
      <div class="reviews-section">
        ...
        <div class="reviews-summary">
          ...
          <div class="reviews-bars">
            ${[5,4,3,2,1].map(l=>{const p=(s[l]||0)/r*100;return h`
                <div class="bar-row">
        ...
        <div class="reviews-list-wrapper">
          <div class="reviews-list ${this.reviewsExpanded?"expanded":""}">
            ${t.map(l=>{const d=Math.min(5,Math.max(0,Math.round(Number(l.rating)||0)));return h`
          ...
          <div class="screenshots">
            ...
            <div class="screenshots-container">
              ...
              <div class="screenshots-row" @scroll=${this._onScreenshotsScroll}>
                ${r.map(l=>h`<img class="screenshot-img" src=${l.url} alt=${l.alt||o} loading="lazy" />`)}
              </div>
    ...
    `}}R(Mo,"properties",{productId:{type:String},customUrl:{type:String},data:{type:Object},relatedProducts:{type:Array},loading:{type:Boolean},descriptionExpanded:{type:Boolean},reviewData:{type:Object},reviewsExpanded:{type:Boolean}}),R(Mo,"styles",k`
  ...
  `);customElements.define("detail-page",Mo);class Fo extends G{constructor(){super(),this.data=null,this.loading=!0,this.currentPage=1,this.currentCategory=""}connectedCallback(){super.connectedCallback(),this._loadData()}updated(t){t.has("currentPage")&&this._loadData()}async _loadData(){var t;this.loading=!0;try{const i=new URLSearchParams;i.set("page",this.currentPage),this.currentCategory&&i.set("category",this.currentCategory);const o=await fetch(`/api/articles?${i}`);if(this.data=await o.json(),(t=this.data)!=null&&t.seo){const s=this.data.seo;ze({title:s.title,keywords:s.keywords,description:s.description})}}catch(i){console.error("Failed to load articles:",i)}this.loading=!1}_navigate(t){window.msApp?window.msApp.navigate(`/article/${t}`):window.location.href=`/article/${t}`}_changeCategory(t){this.currentCategory=t,this.currentPage=1,window.msApp&&window.msApp.navigate("/articles"),this._loadData()}_goToPage(t){t<1||(window.msApp?window.msApp.navigate(t===1?"/articles":"/articles/"+t):window.location.href=t===1?"/articles":"/articles/"+t,this.scrollIntoView({behavior:"smooth"}))}_formatDate(t){if(!t)return"";const i=new Date(t),s=Math.floor((new Date-i)/864e5);return s===0?"今天":s===1?"昨天":s<7?`${s}天前`:i.toLocaleDateString("zh-CN")}_renderPageNumbers(t,i){const o=[],r=Math.max(2,t-2),n=Math.min(i-1,t+2);o.push(1),r>2&&o.push("...");for(let l=r;l<=n;l++)o.push(l);return n<i-1&&o.push("..."),i>1&&o.push(i),o.map((l,d)=>{if(l==="...")return h`<span class="page-ellipsis" key="ellipsis-${d}">...</span>`;const p=l===1?"/articles":`/articles/${l}`;return h`<a class="page-btn page-link ${l===t?"active":""}" href="${p}" data-nav>${l}</a>`})}_renderArticleCard(t){return h`
    ...
    `}}R(Fo,"properties",{data:{type:Object},loading:{type:Boolean},currentPage:{type:Number},currentCategory:{type:String}}),R(Fo,"styles",k`
  ...
  `);customElements.define("articles-page",Fo);class Bo extends G{constructor(){super(),this.slug="",this.data=null,this.loading=!0}updated(t){t.has("slug")&&this.slug&&this._loadData()}async _loadData(){this.loading=!0;try{const t=await fetch(`/api/article/${encodeURIComponent(this.slug)}`);t.ok?this.data=await t.json():this.data=null}catch(t){console.error("Failed to load article:",t),this.data=null}this.loading=!1,this.data&&this.data.article&&this._updatePageMeta()}_updatePageMeta(){const t=this.data.article;ze({title:t.title||"资讯详情",keywords:t.keywords||"",description:t.meta_description||""})}_navigate(t){window.msApp?window.msApp.navigate(`/article/${t}`):window.location.href=`/article/${t}`}_goBack(){window.msApp?window.msApp.navigate("/articles"):window.location.href="/articles"}_formatDate(t){return t?new Date(t).toLocaleDateString("zh-CN",{year:"numeric",month:"long",day:"numeric"}):""}render(){if(this.loading)return h`<div class="loading"><div class="loading-spinner"></div><br>正在加载...</div>`;if(!this.data||!this.data.article)return h`<div class="loading">文章不存在或已被删除</div>`;const{article:t,related:i,popular:o}=this.data;return h`
      <div class="container">
        <div class="main-content">
    ...
    `}}R(Bo,"properties",{slug:{type:String},data:{type:Object},loading:{type:Boolean}}),R(Bo,"styles",k`
    :host { display: block; padding-bottom: 64px; }
    .loading {
      text-align: center; padding: 120px 0;
      color: #767676; font-size: 16px;
  ...
  `);customElements.define("article-detail-page",Bo);const no=new Set(["home","apps","games","about","articles"]);class Vo extends G{constructor(){super(),this.currentRoute="home",this.routeParams={},this._transitioning=!1,this._activatedRoutes=new Set,this._handleRoute(),window.addEventListener("popstate",()=>this._handleRoute())}_handleRoute(){const t=window.location.pathname;if(t==="/"||t==="/home")this.currentRoute="home",this.routeParams={};else if(t==="/apps")this.currentRoute="apps",this.routeParams={};else if(t==="/games")this.currentRoute="games",this.routeParams={};else if(t==="/about")this.currentRoute="about",this.routeParams={};else if(t==="/articles")this.currentRoute="articles",this.routeParams={page:1};else{const i=t.match(/^\/articles\/(\d+)$/);i?(this.currentRoute="articles",this.routeParams={page:parseInt(i[1],10)}):t.startsWith("/article/")?(this.currentRoute="article-detail",this.routeParams={slug:t.split("/article/")[1]}):t.startsWith("/detail/")?(this.currentRoute="detail",this.routeParams={id:t.split("/detail/")[1]}):t==="/desk.html"?(this.currentRoute="detail",this.routeParams={id:"xpdlt6q62bfqkz"}):(this.currentRoute="custom-product",this.routeParams={customUrl:t})}no.has(this.currentRoute)&&this._activatedRoutes.add(this.currentRoute)}navigate(t){const i=this.currentRoute;window.history.pushState({},"",t),this._handleRoute(),this.currentRoute!==i&&window.scrollTo({top:0,behavior:"smooth"})}connectedCallback(){super.connectedCallback(),window.msApp=this,document.addEventListener("click",t=>{const o=t.composedPath().find(s=>s instanceof HTMLAnchorElement&&s.hasAttribute("data-nav"));o&&(t.preventDefault(),this.navigate(o.getAttribute("href")))})}_isActive(t){return this.currentRoute===t}_shouldRender(t){return this._activatedRoutes.has(t)}_renderDynamicPage(){if(no.has(this.currentRoute))return"";switch(this.currentRoute){case"article-detail":return h`<article-detail-page .slug=${this.routeParams.slug}></article-detail-page>`;case"detail":return h`<detail-page .productId=${this.routeParams.id}></detail-page>`;case"custom-product":return h`<detail-page .customUrl=${this.routeParams.customUrl}></detail-page>`;default:return""}}render(){return h`
      ...
      <main>
        ...
        <div class="page-slot ${this._isActive("articles")?"active":""}">${this._shouldRender("articles")?h`<articles-page .currentPage=${this.routeParams.page??1}></articles-page>`:""}</div>
        <div class="page-slot ${no.has(this.currentRoute)?"":"active"}">${this._renderDynamicPage()}</div>
      </main>
      <ms-footer></ms-footer>
    `}}R(Vo,"properties",{currentRoute:{type:String},routeParams:{type:Object},_transitioning:{type:Boolean,state:!0}}),R(Vo,"styles",k`
    :host {
      display: block;
      min-height: 100vh;
  ...
  `);customElements.define("ms-app",Vo);
